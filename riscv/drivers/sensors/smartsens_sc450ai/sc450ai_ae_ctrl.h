...
#define SC450AI_HDR_2X_LONG_EXP_LINE_MAX(vts, vts_s)                  (2 * (vts - vts_s) - 17) //datasheet default value : (2 * (vts - vts_s) - 15) , current value becauese 0x3400 fix to 0x16
#define SC450AI_HDR_2X_LONG_INTEGRATION_TIME_STEP                     (2.0f)

#define SC450AI_HDR_2X_SHORT_EXP_LINE_MIN                             (0.5f)
#define SC450AI_HDR_2X_SHORT_EXP_LINE_MAX(vts_s)                      (2 * vts_s - 15) //datasheet default value : (2 * vts_s - 11) , current value becauese 0x3400 fix to 0x16
