...
#define SC450AI_SENSOR_ID        (0xbd2f)
#define SC450AI_ADDR_BYTE        (2)
#define SC450AI_DATA_BYTE        (1)
#define SC450AI_SWAP_BYTES       (1)
#define SC450AI_INCK_24M         (24)

#define SC450AI_SENSOR_ID_REG_H  (0x3107)
#define SC450AI_SENSOR_ID_REG_L  (0x3108)
...
typedef enum {
    e_SC450AI_setting_sel_min = 0,
    //e_SC450AI_2688X1520_LINEAR_10bit_RGGB_25FPS_4LANE_24M_360Mbps,
    e_SC450AI_2688X1520_LINEAR_10bit_RGGB_30FPS_4LANE_24M_360Mbps,
    //e_SC450AI_2688X1520_HDR_10bit_RGGB_25FPS_4LANE_24M_720Mbps,
    e_SC450AI_2688X1520_HDR_10bit_RGGB_30FPS_4LANE_24M_720Mbps,

    e_SC450AI_setting_special_idx = 0x20, /* index = 32 */

    e_SC450AI_2688X1520_LINEAR_10bit_RGGB_25FPS_2LANE_24M_720Mbps,
    e_SC450AI_2688X1520_LINEAR_10bit_RGGB_30FPS_2LANE_24M_720Mbps,
    e_SC450AI_2688X1520_HDR_10bit_RGGB_25FPS_2LANE_24M_1120Mbps,

    e_SC450AI_2688X1520_LINEAR_10bit_RGGB_25FPS_4LANE_27M_360Mbps,
    e_SC450AI_2688X1520_LINEAR_10bit_RGGB_30FPS_4LANE_27M_360Mbps,
    e_SC450AI_2688X1520_HDR_10bit_RGGB_25FPS_4LANE_27M_720Mbps,
    e_SC450AI_2688X1520_HDR_10bit_RGGB_30FPS_4LANE_27M_720Mbps,

    e_SC450AI_2688X1520_LINEAR_10bit_RGGB_60FPS_4LANE_24M_720Mbps,

    e_SC450AI_setting_sel_max
} SC450AI_SETTING_SEL_E;

AX_S32 sc450ai_reset(ISP_PIPE_ID nPipeId, AX_U32 nResetGpio, AX_U8 nValue);
