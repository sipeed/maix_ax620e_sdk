...
AX_S32 sc850sl_set_slaveaddr(ISP_PIPE_ID nPipeId, AX_U8 nslaveaddr)
{
    ...
    if (nslaveaddr == SC850SL_SLAVE_ADDR1 || nslaveaddr == SC850SL_SLAVE_ADDR2)
        gSc850slSlaveAddr[nPipeId] = nslaveaddr;
    else
        gSc850slSlaveAddr[nPipeId] = SC850SL_SLAVE_ADDR1;
...
AX_S32 sc850sl_read_register(ISP_PIPE_ID nPipeId, AX_U32 nAddr, AX_U32 *pData)
{
    ...
    if(nRet < 0) {
        SNS_ERR("sc850sl read reg failed, ret=%d\n", nRet);
    }
...
AX_S32 sc850sl_write_register(ISP_PIPE_ID nPipeId, AX_U32 addr, AX_U32 data)
{
    ...
    if(nRet < 0) {
        SNS_ERR("sc850sl write reg failed, ret=%d\n", nRet);
    }
...
AX_S32 sc850sl_write_settings(ISP_PIPE_ID nPipeId, AX_U32 setindex)
{
    ...
    SNS_DBG("sc850sl setitng index: %d\n", setindex);

    switch (setindex) {
    case e_SC850SL_3840X2160_LINEAR_10bit_RGGB_30FPS_4LANE_24M_1080Mbps:
        default_setting = &SC850SL_3840X2160_LINEAR_10bit_RGGB_30FPS_4LANE_24M_1080Mbps[0];
        reg_count = sizeof(SC850SL_3840X2160_LINEAR_10bit_RGGB_30FPS_4LANE_24M_1080Mbps) / sizeof(camera_i2c_reg_array);
        break;
    case e_SC850SL_3840X2160_HDR_10bit_RGGB_30FPS_4LANE_24M_1458Mbps:
        default_setting = &SC850SL_3840X2160_HDR_10bit_RGGB_30FPS_4LANE_24M_1458Mbps[0];
        reg_count = sizeof(SC850SL_3840X2160_HDR_10bit_RGGB_30FPS_4LANE_24M_1458Mbps) / sizeof(camera_i2c_reg_array);
        break;
    case e_SC850SL_BINNING_1920X1080_LINEAR_10bit_RGGB_60FPS_2LANE_24M_720Mbps:
        default_setting = &SC850SL_BINNING_1920X1080_LINEAR_10bit_RGGB_60FPS_2LANE_24M_720Mbps[0];
        reg_count = sizeof(SC850SL_BINNING_1920X1080_LINEAR_10bit_RGGB_60FPS_2LANE_24M_720Mbps) / sizeof(camera_i2c_reg_array);
        break;
    case e_SC850SL_3840X2160_LINEAR_10bit_RGGB_30FPS_2LANE_24M_1380Mbps:
        default_setting = &SC850SL_3840X2160_LINEAR_10bit_RGGB_30FPS_2LANE_24M_1380Mbps[0];
        reg_count = sizeof(SC850SL_3840X2160_LINEAR_10bit_RGGB_30FPS_2LANE_24M_1380Mbps) / sizeof(camera_i2c_reg_array);
        break;
    default:
    ...
    SNS_DBG("sc850sl setitng index: %d, reg_count %d\n", setindex, reg_count);
    for (i = 0; i < reg_count; i++) {
        sc850sl_write_register(nPipeId, (default_setting + i)->addr, ((default_setting + i)->value));
#ifdef SENSOR_DEBUG
        rt_thread_mdelay(2);
        rBuf[0] = sc850sl_reg_read(nPipeId, (default_setting + i)->addr);
