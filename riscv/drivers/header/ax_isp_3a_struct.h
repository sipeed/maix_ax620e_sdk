...
#define AX_ISP_AWB_GRID_WEIGHT_ROW_MAX      (24)
#define AX_ISP_AWB_GRID_WEIGHT_COLUMN_MAX   (32)
...
//     AX_U32  nTrigerValue1st[2];               /* Lux                      nTrigerType1st = 0  Accuracy:U22.10  Range:[0, 4294967295 (4*1024*1024*1024)]
...
//                                               */
//     AX_U32  nTrigerValue2nd[2];               /* Lux                      nTrigerType2nd = 0  Accuracy:U22.10  Range:[0, 4294967295 (4*1024*1024*1024)]
...
typedef struct {
    ...
    AX_U8  nSpatialSegmetNum;                                   /* Accuracy:U8  Range:[0, 64] */
    ...
    // AX_U16 nGreenCutWeight;                       /* Accuracy: U1.10 Range: [0x0, 0x400] */
    // AX_U32 nGreenCutBreakAngle;                   /* Accuracy:U4.20 Range:[0, 16777215 (16*1024*1024)] */
    // AX_S32 nGreenCutOffsetRg;                     /* Accuracy:S4.20 Range:[-16777215, 16777215 (16*1024*1024)] */
    // AX_S32 nGreenCutOffsetBg;                     /* Accuracy:S4.20 Range:[-16777215, 16777215 (16*1024*1024)] */
...
#define AX_AE_FACE_TARGET_MAX_NUM 10
typedef struct{
    AX_U8      nSize;                                 /* Accuracy: U8 Range: [0x0, 0xA] */
    AX_U32     nRefList[AX_AE_FACE_TARGET_MAX_NUM];     /* <lux value> if nFaceTargetMode = 1, use lux range;
                                                       * Accuracy: U22.10
                                                       * lux range: [0x0, 0x3D090000]*/
    AX_U32     nFaceTargetList[AX_AE_FACE_TARGET_MAX_NUM]; /* Accuracy: U8.10  Range: [0x0, 0x3FC00] */
...
typedef struct
{
    ...
    AX_U32 nToFastLumaThUnder;  /* Accuracy: U1.10 Range: [0x0, 0x400]*/
...
#define AX_AE_FACE_SCORE_LEVEL (6)
#define AX_AE_FACE_DISTANCE_LEVEL (6)
#define AX_AE_FACE_DETECTION_MAX_NUM (10)
typedef struct
{
    AX_U8  nEnable;                                      /* 0: disable face ae 1: enable face ae */
    AX_ISP_IQ_AE_FACE_TARGET_CURVE_T tFaceTargetCurve;
    AX_U32 nFaceScoreList[AX_AE_FACE_SCORE_LEVEL];               /* Face score level list:order from low to high. Accuracy: U1.10 Range: [0x0, 0x400] */
    AX_U32 nFaceScoreWeightList[AX_AE_FACE_SCORE_LEVEL];         /* Weight table based on score level: order from low to high. Accuracy: U1.10 Range: [0x0, 0x400] */
    AX_U32 nFaceDistanceList[AX_AE_FACE_DISTANCE_LEVEL];       /* Face distance between image center and face center;order from low to high. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U32 nFaceDistanceWeightList[AX_AE_FACE_DISTANCE_LEVEL];         /* Distance weight table: for calculating face score:order from high to low. Accuracy: U1.10 Range: [0x0, 0x400] */
    AX_U32 nFaceWeight;                                      /* the weight of face meanluma counted into frame meanluma; Accuracy: U1.10 Range: [0x0, 0x400] */
    AX_U32 nFaceTargetWeight;                                /* the weight of face target counted into frame target; Accuracy: U1.10 Range: [0x0, 0x400] */
...
typedef struct {
    AX_U32 nFaceStartX;                   /* Face ROI start point. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U32 nFaceStartY;                   /* Face ROI start point. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U32 nFaceWidth;                    /* Face ROI width. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_U32 nFaceHeight;                   /* Face ROI height. Accuracy: U1.10 Range: [0x0, 0x400]*/
} AX_ISP_AE_FACE_RECT_INPUT_PARAM_T;

typedef struct {
    AX_U32 nFaceNum;                                        /* Numbers of detected face. Accuracy: U32 Range: [0x0, 0xA] */
    AX_U32 nFaceID[AX_AE_FACE_DETECTION_MAX_NUM];                                         /* ID of each face. Accuracy: U32 */
    AX_U32 nFaceConfidence[AX_AE_FACE_DETECTION_MAX_NUM];             /* Confidence of each face. Accuracy: U1.10 Range: [0x0, 0x400]*/
    AX_ISP_AE_FACE_RECT_INPUT_PARAM_T tFaceInfos[AX_AE_FACE_DETECTION_MAX_NUM];              /* Input Information of each face */
} AX_ISP_AE_FACE_DETECTION_PARAM_T;
...
typedef struct
{
    ...
    AX_U32 nCompFactorList[AX_ISP_AE_OVEREXP_COMP_LUT_MAX_NUM]; /* Accuracy: U4.10 Range: [0x400, 0x2800] */
...
typedef struct
{
    AX_U32 nNoiseLevel;    /* Accuracy: U1.10  Range: [0x0, 0x400] */
...
typedef struct {
    ...
    AX_U64 nSeqNum;      /* Accuracy: U64 Range: [0x0,0xFFFFFFFFFFFFFFFF]*/
