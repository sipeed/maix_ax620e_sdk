...
typedef struct {
    ...
    AX_U16 nKMax[AX_ISP_AUTO_TABLE_MAX_NUM];             /* limit brightness. Accuracy: U12.4 Range: [0, 65535], default 65535 */
    ...
    AX_U16 nWinSize[AX_ISP_AUTO_TABLE_MAX_NUM];          /* for hist. Accuracy: U16.0 Range: [128, 256, 512, 1024], default 512 */
    ...
    AX_ISP_IQ_RLTM_HF_ENH_T tHighFreqEnh[AX_ISP_AUTO_TABLE_MAX_NUM];
    AX_ISP_IQ_RLTM_LF_ENH_T tLowFreqEnh[AX_ISP_AUTO_TABLE_MAX_NUM];
...
typedef struct {
    ...
    AX_ISP_IQ_RLTM_LF_ENH_GBL_T tLfEnhGlb;
...
typedef struct {
    AX_U8  nCalcMode;                             /* calc_mode, default 0. Accuracy: U1.0 Range: [0, 1] */
    ...
    AX_U8  nMeshSize;                             /* mesh_size, default 32. Accuracy: U8.0 Range: [8, 128] */
...
typedef struct {
    ...
    AX_U32                      nRefVal[AX_ISP_DEMOSAIC_AUTO_MAX_NUM];                  /* Accuracy: U22.10 GainRange: [0x400, 0xFFFFFFFF] LuxRange: [0x400, 0xFFFFFFFF] */
...
typedef struct {
    AX_U8                       nParamGrpNum;                                                   /* Accuracy: U8.0 Range: [0x1, 0x10] Default: 0x10 */
    AX_U32                      nRefVal[AX_ISP_FCC_AUTO_MAX_NUM];                               /* Accuracy: U22.10 GainRange: [0x400, 0xFFFFFFFF] LuxRange: [0x400, 0xFFFFFFFF]*/
...
typedef struct {
    AX_U8                    nParamGrpNum;                                                              /* Accuracy: U8.0 Range: [0x1, 0x10] Default: 0x10 */
    AX_U32                   nRefVal[AX_ISP_GIC_AUTO_MAX_NUM];                                          /* Accuracy: U22.10 GainRange: [0x400, 0xFFFFFFFF] LuxRange: [0x400, 0xFFFFFFFF] */
...
typedef struct
{
    AX_U32 nHueTbl[AX_ISP_3DLUT_LUT2D_RADIUS_NUM][AX_ISP_3DLUT_LUT2D_THETA_NUM]; /* Accuracy: U9.0 Range: [0, 0x1FF] */
    AX_U32 nSatTbl[AX_ISP_3DLUT_LUT2D_RADIUS_NUM][AX_ISP_3DLUT_LUT2D_THETA_NUM]; /* Accuracy: U1.14 Range: [0, 0x7FFF] */
...
typedef struct {
    ...
    AX_ISP_LUT_MODE_E                   eLutMode;                                   /* Interpolation method of LUT table, 0: linear, 1: exponential, default:0. Accuracy: U1.0 Range: [0, 1], default: 1 */
...
#define AX_ISP_SHP_AUTO_MAX_NUM            (16)

typedef struct {
    AX_S16  nC3x3LogGain[AX_ISP_SHP_GAIN_SIZE];             /* shp_c3x3_log_gain. default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nC3x3GainLimit[AX_ISP_SHP_LIMIT_SIZE];          /* shp_c3x3_gain_limit. default: 0,255. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nC3x3CorBaseGain;                               /* shp_c3x3_coring_base_gain. default: 0. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nC3x3CorSlope;                                  /* shp_c3x3_coring_slope. default: 4. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nC3x3CorOffset;                                 /* shp_c3x3_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nC3x3Limit[AX_ISP_SHP_LIMIT_SIZE];              /* shp_c3x3_limit. default: 512,512. Accuracy: U8.2 Range: [0, 1023] */
    AX_S16  nC5x5LogGain[AX_ISP_SHP_GAIN_SIZE];             /* shp_c5x5_log_gain.default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nC5x5GainLimit[AX_ISP_SHP_LIMIT_SIZE];          /* shp_c5x5_gain_limit. default: 0,255. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nC5x5CorBaseGain;                               /* shp_c5x5_coring_base_gain. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nC5x5CorSlope;                                  /* shp_c5x5_coring_slope. default: 4. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nC5x5CorOffset;                                 /* shp_c5x5_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nC5x5Limit[AX_ISP_SHP_LIMIT_SIZE];              /* shp_c5x5_limit. default: 512,512. Accuracy: U8.2 Range: [0, 1023] */
    AX_S16  nD5x5LogGain[AX_ISP_SHP_GAIN_SIZE];             /* shp_d5x5_log_gain. default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nD5x5GainLimit[AX_ISP_SHP_LIMIT_SIZE];          /* shp_d5x5_gain_limit. default: 0,512. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nD5x5CorBaseGain;                               /* shp_d5x5_coring_base_gain. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nD5x5CorSlope;                                  /* shp_d5x5_coring_slope. default: 4. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nD5x5CorOffset;                                 /* shp_d5x5_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nD5x5Limit[AX_ISP_SHP_LIMIT_SIZE];              /* shp_d5x5_limit. default: 512,512. Accuracy: U1 Range: [0, 1023] */
    AX_S16  nC7x7LogGain[AX_ISP_SHP_GAIN_SIZE];             /* shp_c7x7_log_gain. default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nC7x7GainLimit[AX_ISP_SHP_LIMIT_SIZE];          /* shp_c7x7_gain_limit. default: 0,512. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nC7x7CorBaseGain;                               /* shp_c7x7_coring_base_gain. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nC7x7CorSlope;                                  /* shp_c7x7_coring_slope. default: 0. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nC7x7CorOffset;                                 /* shp_c7x7_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nC7x7Limit[AX_ISP_SHP_LIMIT_SIZE];              /* shp_c7x7_limit. default: 512,512. Accuracy: U8.2 Range: [0, 1023] */
...
typedef struct {
    AX_U8   nParamGrpNum;                                   /* default: 16. Accuracy: U8.0 Range: [1, 16] */
    AX_U32  nRefVal[AX_ISP_SHP_AUTO_MAX_NUM];               /* Gain: Accuracy: U22.10 Range: [0x400, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_S16  nC3x3LogGain[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_GAIN_SIZE];             /* shp_c3x3_log_gain. default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nC3x3GainLimit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];          /* shp_c3x3_gain_limit. default: 0,255. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nC3x3CorBaseGain[AX_ISP_SHP_AUTO_MAX_NUM];                               /* shp_c3x3_coring_base_gain. default: 0. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nC3x3CorSlope[AX_ISP_SHP_AUTO_MAX_NUM];                                  /* shp_c3x3_coring_slope. default: 4. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nC3x3CorOffset[AX_ISP_SHP_AUTO_MAX_NUM];                                 /* shp_c3x3_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nC3x3Limit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];              /* shp_c3x3_limit. default: 512,512. Accuracy: U8.2 Range: [0, 1023] */
    AX_S16  nC5x5LogGain[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_GAIN_SIZE];             /* shp_c5x5_log_gain.default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nC5x5GainLimit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];          /* shp_c5x5_gain_limit. default: 0,255. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nC5x5CorBaseGain[AX_ISP_SHP_AUTO_MAX_NUM];                               /* shp_c5x5_coring_base_gain. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nC5x5CorSlope[AX_ISP_SHP_AUTO_MAX_NUM];                                  /* shp_c5x5_coring_slope. default: 4. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nC5x5CorOffset[AX_ISP_SHP_AUTO_MAX_NUM];                                 /* shp_c5x5_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nC5x5Limit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];              /* shp_c5x5_limit. default: 512,512. Accuracy: U8.2 Range: [0, 1023] */
    AX_S16  nD5x5LogGain[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_GAIN_SIZE];             /* shp_d5x5_log_gain. default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nD5x5GainLimit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];          /* shp_d5x5_gain_limit. default: 0,512. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nD5x5CorBaseGain[AX_ISP_SHP_AUTO_MAX_NUM];                               /* shp_d5x5_coring_base_gain. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nD5x5CorSlope[AX_ISP_SHP_AUTO_MAX_NUM];                                  /* shp_d5x5_coring_slope. default: 4. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nD5x5CorOffset[AX_ISP_SHP_AUTO_MAX_NUM];                                 /* shp_d5x5_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nD5x5Limit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];              /* shp_d5x5_limit. default: 512,512. Accuracy: U1 Range: [0, 1023] */
    AX_S16  nC7x7LogGain[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_GAIN_SIZE];             /* shp_c7x7_log_gain. default: 0,0. Accuracy: S3.5 Range: [-256, 255] */
    AX_U8   nC7x7GainLimit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];          /* shp_c7x7_gain_limit. default: 0,512. Accuracy: U4.4 Range: [0, 255] */
    AX_U8   nC7x7CorBaseGain[AX_ISP_SHP_AUTO_MAX_NUM];                               /* shp_c7x7_coring_base_gain. default: 0. Accuracy: U0.4 Range: [0, 15] */
    AX_U8   nC7x7CorSlope[AX_ISP_SHP_AUTO_MAX_NUM];                                  /* shp_c7x7_coring_slope. default: 0. Accuracy: U2.2 Range: [0, 15] */
    AX_U8   nC7x7CorOffset[AX_ISP_SHP_AUTO_MAX_NUM];                                 /* shp_c7x7_coring_offset. default: 0. Accuracy: U4.2 Range: [0, 63] */
    AX_U16  nC7x7Limit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];              /* shp_c7x7_limit. default: 512,512. Accuracy: U8.2 Range: [0, 1023] */
    AX_U8   nShpHpfBsigma[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_HPF_NUM];              /* shp_hpf_bsigma. default: 16,16,16. Accuracy: U3.5 Range: high:[0, 48]. med:[0, 80]. low:[0, 96] */
    AX_U8   nShpHpfDsigma[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_HPF_NUM];              /* shp_hpf_dsigma. default: 32,32,32. Accuracy: U3.5 Range: [0, 255] */
    AX_U8   nShpHpfScale[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_HPF_NUM];               /* shp_hpf_scale. default: 128,128,128. Accuracy: U1.7 Range: [0, 128] */
    AX_U8   nShpGain[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_GAIN_SIZE];                 /* shp_gain. Accuracy: U4.4 Range: [16, 255] */
    AX_S16  nShpLimit[AX_ISP_SHP_AUTO_MAX_NUM][AX_ISP_SHP_LIMIT_SIZE];               /* shp_limit. default: 0,0. Accuracy: S8.4 nShpLimit[0] Range: [-4096, 0], nShpLimit[1] Range: [0, 4095] */
    AX_S16  nGrainLogGain[AX_ISP_SHP_AUTO_MAX_NUM];                                  /* shp_grain_log_gain. default: 0. Accuracy: U1 Range: [-256, 255] */
...
typedef struct {
    ...
    AX_U8                   nColorSpread[AX_ISP_SHP_COLOR_TARGET_NUM][AX_ISP_SHP_COLOR_SIZE];  /* shp_mask_clnp_yuv_t_grad. default: 0,0.... Accuracy: U4 Range: [0, 15] */
...
typedef struct {
    AX_U8                   nC3x3Enable;                                                       /* shp_c3x3_enable. default: 0. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC3x3MotionMskEn;                                                  /* shp_C3x3_mask_motion on-off. default: 0. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC3x3MotionLutLevel;                                               /* shp_C3x3_mask_motion_lut_level. default: 4,4.... Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC3x3LumaMskEn;                                                    /* shp_C3x3_mask_luma on-off. default: 0. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC3x3LumaLutLevel;                                                 /* shp_C3x3_mask_luma_lut_level. default: 4,4.... Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC3x3TextureMskEn;                                                 /* shp_C3x3_mask_texture_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC3x3TextureLutLevel;                                              /* shp_C3x3_mask_texture_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC3x3TextureLutMotionLevel;                                        /* shp_C3x3_mask_texture_lut_motion_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC3x3ClnpMskEn[AX_ISP_SHP_COLOR_MASK_NUM];                         /* shp_C3x3_mask_clnp_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC3x3ClnpLutLevel[AX_ISP_SHP_COLOR_MASK_NUM];                      /* shp_C3x3_mask_clnp_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_S8                   nC3x3MotionLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                       /* shp_C3x3_mask_motion_lut. default: 0,0.... Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC3x3LumaLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                         /* shp_C3x3_mask_luma_lut. default: 0,0.... Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC3x3TextureLut[AX_ISP_SHP_TEXTURE_LUT_SIZE];                      /* shp_C3x3_mask_texture_lut. default: 0,0.... Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC3x3TextureLutMotion[AX_ISP_SHP_TEXTURE_LUT_SIZE];                /* shp_C3x3_mask_texture_lut_motion. default: 0,0.... Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC3x3ClnpLut[AX_ISP_SHP_COLOR_MASK_NUM][AX_ISP_SHP_GENERAL_LUT_SIZE];/* shp_C3x3_mask_clnp_lut. default: 0,0.... Accuracy: S3.4 Range: [-128, 127] */
    AX_U8                   nC3x3OsLimit[AX_ISP_SHP_LIMIT_SIZE];                               /* shp_C3x3_os_limit. Accuracy: U5.2 Range: [0, 127] */
    AX_U8                   nC3x3OsGain[AX_ISP_SHP_GAIN_SIZE];                                 /* shp_C3x3_os_gain. Accuracy: U1.3 Range: [0, 8] */
} AX_ISP_IQ_SHP_C3X3_CONTROL_T;

typedef struct {
    AX_U8                   nC5x5Enable;                                                       /* shp_c5x5_enable. default: 0. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC5x5MotionMskEn;                                                  /* shp_C5x5_mask_motion on-off. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC5x5MotionLutLevel;                                               /* shp_C5x5_mask_motion_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC5x5LumaMskEn;                                                    /* shp_C5x5_mask_luma on-off. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC5x5LumaLutLevel;                                                 /* shp_C5x5_mask_luma_lu_levelt. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC5x5TextureMskEn;                                                 /* shp_C5x5_mask_texture_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC5x5TextureLutLevel;                                              /* shp_C5x5_mask_texture_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC5x5TextureLutMotionLevel;                                        /* shp_C5x5_mask_texture_lut_motion_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC5x5ClnpMskEn[AX_ISP_SHP_COLOR_MASK_NUM];                         /* shp_C5x5_mask_clnp_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC5x5ClnpLutLevel[AX_ISP_SHP_COLOR_MASK_NUM];                      /* shp_C5x5_mask_clnp_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_S8                   nC5x5MotionLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                       /* shp_C5x5_mask_motion_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC5x5LumaLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                         /* shp_C5x5_mask_luma_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC5x5TextureLut[AX_ISP_SHP_TEXTURE_LUT_SIZE];                      /* shp_C5x5_mask_texture_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC5x5TextureLutMotion[AX_ISP_SHP_TEXTURE_LUT_SIZE];                /* shp_C5x5_mask_texture_lut_motion. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC5x5ClnpLut[AX_ISP_SHP_COLOR_MASK_NUM][AX_ISP_SHP_GENERAL_LUT_SIZE];/* shp_C5x5_mask_clnp_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_U8                   nC5x5OsLimit[AX_ISP_SHP_LIMIT_SIZE];                               /* shp_C5x5_os_limit. Accuracy: U5.2 Range: [0, 127] */
    AX_U8                   nC5x5OsGain[AX_ISP_SHP_GAIN_SIZE];                                 /* shp_C5x5_os_gain. Accuracy: U1.3 Range: [0, 8] */
} AX_ISP_IQ_SHP_C5X5_CONTROL_T;

typedef struct {
    AX_U8                   nD5x5Enable;                                                       /* shp_d5x5_enable. default: 0. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nD5x5MotionMskEn;                                                  /* shp_D5x5_mask_motion on-off. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nD5x5MotionLutLevel;                                               /* shp_D5x5_mask_motion_lut_level. U2.2 Range: [0, 16] */
    AX_U8                   nD5x5LumaMskEn;                                                    /* shp_D5x5_mask_luma on-off. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nD5x5LumaLutLevel;                                                 /* shp_D5x5_mask_luma_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nD5x5TextureMskEn;                                                 /* shp_D5x5_mask_texture_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nD5x5TextureLutLevel;                                              /* shp_D5x5_mask_texture_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nD5x5TextureLutMotionLevel;                                        /* shp_D5x5_mask_texture_lut_motion_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nD5x5ClnpMskEn[AX_ISP_SHP_COLOR_MASK_NUM];                         /* shp_D5x5_mask_clnp_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nD5x5ClnpLutLevel[AX_ISP_SHP_COLOR_MASK_NUM];                      /* shp_D5x5_mask_clnp_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_S8                   nD5x5MotionLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                       /* shp_D5x5_mask_motion_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nD5x5LumaLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                         /* shp_D5x5_mask_luma_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nD5x5TextureLut[AX_ISP_SHP_TEXTURE_LUT_SIZE];                      /* shp_D5x5_mask_texture_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nD5x5TextureLutMotion[AX_ISP_SHP_TEXTURE_LUT_SIZE];                /* shp_D5x5_mask_texture_lut_motion. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nD5x5ClnpLut[AX_ISP_SHP_COLOR_MASK_NUM][AX_ISP_SHP_GENERAL_LUT_SIZE];/* shp_D5x5_mask_clnp_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_U8                   nD5x5OsLimit[AX_ISP_SHP_LIMIT_SIZE];                               /* shp_D5x5_os_limit. Accuracy: U5.2 Range: [0, 127] */
    AX_U8                   nD5x5OsGain[AX_ISP_SHP_GAIN_SIZE];                                 /* shp_D5x5_os_gain. Accuracy: U1.3 Range: [0, 8] */
    /* directional and non-directional sharpen blending weights */
    AX_U8                   nD5x5DirEdgeLevelLut[AX_ISP_SHP_EDGE_LEVEL_LUT_SIZE];                    /* shp_D5x5_dir_edge_level_lut. Accuracy: U0.8 Range: [0, 255] */
} AX_ISP_IQ_SHP_D5X5_CONTROL_T;

typedef struct {
    AX_U8                   nC7x7Enable;                                                       /* shp_c7x7_enable. default: 0. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC7x7MotionMskEn;                                                  /* shp_C7x7_mask_motion on-off. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC7x7MotionLutLevel;                                               /* shp_C7x7_mask_motion_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC7x7LumaMskEn;                                                    /* shp_C7x7_mask_luma on-off. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC7x7LumaLutLevel;                                                 /* shp_C7x7_mask_luma_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC7x7TextureMskEn;                                                 /* shp_C7x7_mask_texture_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC7x7TextureLutLevel;                                              /* shp_C7x7_mask_texture_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC7x7TextureLutMotionLevel;                                        /* shp_C7x7_mask_texture_lut_motion_level. Accuracy: U2.2 Range: [0, 16] */
    AX_U8                   nC7x7ClnpMskEn[AX_ISP_SHP_COLOR_MASK_NUM];                         /* shp_C7x7_mask_clnp_enable. Accuracy: U1 Range: [0, 1] */
    AX_U8                   nC7x7ClnpLutLevel[AX_ISP_SHP_COLOR_MASK_NUM];                      /* shp_C7x7_mask_clnp_lut_level. Accuracy: U2.2 Range: [0, 16] */
    AX_S8                   nC7x7MotionLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                       /* shp_C7x7_mask_motion_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC7x7LumaLut[AX_ISP_SHP_GENERAL_LUT_SIZE];                         /* shp_C7x7_mask_luma_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC7x7TextureLut[AX_ISP_SHP_TEXTURE_LUT_SIZE];                      /* shp_C7x7_mask_texture_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC7x7TextureLutMotion[AX_ISP_SHP_TEXTURE_LUT_SIZE];                /* shp_C7x7_mask_texture_lut_motion. Accuracy: S3.4 Range: [-128, 127] */
    AX_S8                   nC7x7ClnpLut[AX_ISP_SHP_COLOR_MASK_NUM][AX_ISP_SHP_GENERAL_LUT_SIZE];/* shp_C7x7_mask_clnp_lut. Accuracy: S3.4 Range: [-128, 127] */
    AX_U8                   nC7x7OsLimit[AX_ISP_SHP_LIMIT_SIZE];                               /* shp_C7x7_os_limit. Accuracy: U5.2 Range: [0, 127] */
    AX_U8                   nC7x7OsGain[AX_ISP_SHP_GAIN_SIZE];                                 /* shp_C7x7_os_gain. Accuracy: U1.3 Range: [0, 8] */
} AX_ISP_IQ_SHP_C7X7_CONTROL_T;
...
typedef struct {
    ...
    AX_ISP_IQ_SHP_C3X3_CONTROL_T    tC3x3Control;
    AX_ISP_IQ_SHP_C5X5_CONTROL_T    tC5x5Control;
    AX_ISP_IQ_SHP_D5X5_CONTROL_T    tD5x5Control;
    AX_ISP_IQ_SHP_C7X7_CONTROL_T    tC7x7Control;
...
typedef struct {
    ...
    AX_U8   nYnrSmooth[AX_ISP_YNR_CMASK_SMOOTH_SIZE];   /* ynr cmask smooth [0]:Y, [1]:U, [2]:V. Accuracy: U8 Range: [0, 255] */
...
typedef struct {
    AX_U8   nParamGrpNum;                                                       /* Accuracy: U8.0 Range: [0, AX_ISP_AUTO_TABLE_MAX_NUM] */
    AX_U32  nRefVal[AX_ISP_AUTO_TABLE_MAX_NUM];                                 /* Gain: Accuracy: U22.10 Range: [0x400, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U8   nCnrLevel[AX_ISP_AUTO_TABLE_MAX_NUM];                               /* cnr level. Accuracy: U1.4 Range: [0, 16] */
 ...
 ************************************************************************************/
#define AX_ISP_HS2DLUT_H_SIZE            (25)
#define AX_ISP_HS2DLUT_V_SIZE            (17)
#define AX_ISP_HS2DLUT_REF_SEG_NUM_MAX   (12)
#define AX_ISP_HS2DLUT_CCT_SEG_NUM_MAX   (16)

typedef struct {
    AX_S16  nHueLut[AX_ISP_HS2DLUT_H_SIZE][AX_ISP_HS2DLUT_V_SIZE];    /* hue lut. Accuracy: S8.7 Range: [-23040, 23040] */
...
} AX_ISP_IQ_HS2DLUT_CONVERGE_PARAM_T;
...
typedef struct
{
    ...
    AX_ISP_IQ_HS2DLUT_CONVERGE_PARAM_T  tConvergeParam;
...
typedef struct {
    ...
    AX_U8       nSignalRangeMode;                   /* jpeg Default:[0, 255], Video Default:[16, 255], Customer[0, 255], Accuracy: U2 Range: [0, 2] */
...
typedef enum {
    AX_ISP_AE0_STAT_ITP_PREHDR      = 0,
    AX_ISP_AE0_STAT_IFE_PREHDR      = 1,
    AX_ISP_AE0_STAT_PREHDR_POS_MAX  = 2,
} AX_ISP_AE0_STAT_PREHDR_POS_E;

typedef enum {
    AX_ISP_AE1_STAT_ITP_PREHDR      = 0,
    AX_ISP_AE1_STAT_IFE_PREHDR      = 1,
...
typedef struct {
    ...
    AX_U16 nRoiRegionNumV;                      /* vertRegionNum, Accuracy: U10.0, Range: Grid0_Roi[1, 54], Grid1_Roi[1, 512] */
    AX_U16 nRoiRegionW;                         /* regionW, must be even, Accuracy: U10.0, Range: [16, 512], nRoiOffsetH + (nRoiRegionNumH * nRoiRegionW) <= hsize */
    AX_U16 nRoiRegionH;                         /* regionH, must be even, Accuracy: Grid0_Roi: U10.0, Range[2, 512], Grid1_Roi: U11.0, Range[256, 1024], nRoiOffsetV + (nRoiRegionNumV * nRoiRegionH) <= vsize */
...
typedef enum {
    ...
    AX_ISP_AWB_STAT_ITP_PREHDR_BPC0     = 2,                           /* preHDR in ITP */
    AX_ISP_AWB_STAT_ITP_PREHDR_BPC1     = 3,                           /* preHDR in ITP */
...
typedef struct {
    AX_S32 nRThr;                                                       /* AWB RThr.  Accuracy: S16.4 Range: [-2^20, 2^20-1] */
    AX_S32 nBThr;                                                       /* AWB BThr.  Accuracy: S16.4 Range: [-2^20, 2^20-1] */
    AX_S32 nGrThr;                                                      /* AWB GrThr. Accuracy: S16.4 Range: [-2^20, 2^20-1] */
    AX_S32 nGbThr;                                                      /* AWB GbThr. Accuracy: S16.4 Range: [-2^20, 2^20-1] */
    AX_S32 nYThr;                                                       /* AWB YThr.  Accuracy: S16.4 Range: [-2^20, 2^20-1] */
} AX_ISP_IQ_AWB_STAT_THR_T;

typedef struct {
    AX_ISP_IQ_AWB_STAT_THR_T tLowThr;
    AX_ISP_IQ_AWB_STAT_THR_T tHighThr;
    AX_S32                   nLumaThr[AX_AWB_GRID_LUMA_THR_NUM];        /* thr for luma slice . Accuracy: S16.4 Range: [-2^20, 2^20-] */
...
typedef struct {
    ...
    AX_S32 nWClip;                                                      /* NearGray WhiteClip Accuracy: S16.4 Range: [-2^20, 2^20 - 1] */
    AX_S16 nSlope[AX_AWB_WIN_COORD_NUM][AX_AWB_WIN_BOUND_NUM];          /* NearGray BoundarySlope 0: B-G(X) 1: R-G(Y) 0: upper bound 1: lower bound Accuracy: S8.4 Range: [-4096, 4095] */
    AX_S32 nOffset[AX_AWB_WIN_COORD_NUM][AX_AWB_WIN_BOUND_NUM];         /* NearGray BoundaryOffset 0: B-G(X) 1: R-G(Y) 0: upper bound 1: lower bound  Accuracy: S16.4 Range: [-2^20 2^20-1] */
...
typedef struct {
    ...
    AX_S32                    nWinLumaThr[AX_AWB_WIN_LUMA_CHN_THR_NUM];  /* window luma thr. Accuracy: S16.4 Range: [-2^20, 2^20-1] */
 ...
 ************************************************************************************/
typedef struct {
    AX_U64 nUnSatGridSum[AX_AWB_GRID_CHN];                              /* not saturated pixel sum, Accuracy: U34.4, Range: [0, 2^38-1] */
    AX_U32 nUnSatGridNum;                                               /* not saturated pixel num, Accuracy: U18 , Range: [0, 2^18-1] */
} AX_AWB_GRID_STATS_T;
...
typedef enum {
    ...
    AX_ISP_AF_STAT_ITP_PREHDR_BPC_LONG_FRMAE    = 3,                    /* itp bpc long frame */
    AX_ISP_AF_STAT_ITP_PREHDR_BPC_SHORT_FRMAE   = 4,                    /* itp bpc short frame */
    AX_ISP_AF_STAT_IFE_PREHDR_LONG_FRMAE        = 5,                    /* ife long frame */
    AX_ISP_AF_STAT_IFE_PREHDR_SHORT_FRMAE       = 6,                    /* ife short frame */
...
typedef struct  {
    ...
    AX_U8  nLutMode;                                                    /* lut_mode. Default: 0 Accuracy: U2.0 Range: [0x0, 0x2] */
...
typedef struct  {
    ...
    AX_U16 nWienerFactor[AX_ISP_RAW2DNR_SETTING_NUM][AX_ISP_RAW2DNR_LUT_SIZE];      /* wiener_factor. Default: (512, 512, ..., 512) Accuracy: U4.8 Range: [0x0, 0xfff] */
    AX_U8  nNlmFactor[AX_ISP_RAW2DNR_SETTING_NUM][AX_ISP_RAW2DNR_LUT_SIZE];         /* nlm_factor. Default: (16, 16, ..., 16) Accuracy: U4.4 Range: [0x0, 0xff] */
...
typedef struct  {
    AX_U8  nParamGrpNum;                                                                                       /* Accuracy: U8.0 Range: [0, AX_ISP_AUTO_TABLE_MAX_NUM] */
    AX_U32 nRefVal[AX_ISP_AUTO_TABLE_MAX_NUM];                                                                 /* Gain: Accuracy: U22.10 Range: [0x400, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U8  nEdgePreserveRatio[AX_ISP_AUTO_TABLE_MAX_NUM];                                                      /* freqsep_edge_preserve. Default: 128 Accuracy: U0.8 Range: [0x0, 0xff] */
    AX_U8  nNoiseProfileFactor[AX_ISP_AUTO_TABLE_MAX_NUM];                                                     /* bayer lut and y lut. Default: 128 Accuracy: U1.7 Range: [0x0, 0xff] */
    AX_U16 nWienerFactor[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_RAW2DNR_SETTING_NUM][AX_ISP_RAW2DNR_LUT_SIZE];      /* wiener_factor. Default: (512, 512, ..., 512) Accuracy: U4.8 Range: [0x0, 0xfff] */
    AX_U8  nNlmFactor[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_RAW2DNR_SETTING_NUM][AX_ISP_RAW2DNR_LUT_SIZE];         /* nlm_factor. Default: (16, 16, ..., 16) Accuracy: U4.4 Range: [0x0, 0xff] */
    AX_U8  nInterChannelStrength[AX_ISP_AUTO_TABLE_MAX_NUM];                                                   /* nlm_inter_g_strength. Default: 255 Accuracy: U0.8 Range: [0x0, 0xff] */
    AX_U8  nHfNrStrength[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_RAW2DNR_SETTING_NUM];                               /* org_blend[0]. Default: (128, 128) Accuracy: U0.8 Range: [0x0, 0xff] */
    AX_U8  nMfNrStrength[AX_ISP_AUTO_TABLE_MAX_NUM][AX_ISP_RAW2DNR_SETTING_NUM];                               /* org_blend[1]. Default: (128, 128) Accuracy: U0.8 Range: [0x0, 0xff] */
...
typedef struct {
    ...
    AX_U32    nBiasIn[AX_ISP_AINR_OFFSET_NUM];                                        /*Accuracy: U16.4 Range: [0,1048575],Default:[0,0,0,0]*/
    AX_U32    nBiasOut[AX_ISP_AINR_OFFSET_NUM];                                       /*Accuracy: U16.4 Range: [0,1048575],Default:[0,0,0,0]*/
    AX_U32    nBiasIn2D[AX_ISP_AINR_OFFSET_NUM];                                      /*Accuracy: U16.4 Range: [0,1048575],Default:[0,0,0,0]*/
    AX_U32    nBiasIn3D[AX_ISP_AINR_OFFSET_NUM];                                      /*Accuracy: U16.4 Range: [0,1048575],Default:[0,0,0,0]*/
...
typedef struct {
    ...
    AX_U32    nRefValStart[AX_ISP_AINR_REF_VALUE_MAX_NUM];                                  /* Gain start: Accuracy: U22.10 Range: [100, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
    AX_U32    nRefValEnd[AX_ISP_AINR_REF_VALUE_MAX_NUM];                                    /* Gain end: Accuracy: U22.10 Range: [100, 0xFFFFFFFF]; Lux: Accuracy: U22.10 Range: [0, 0xFFFFFFFF] */
 ...
 *  EIS Stat Config
 ************************************************************************************/
#define AX_EIS_LUT_NUM   (33)
#define AX_PROJ_SHIFT_BIT_DIRECTION_NUM   (2)

typedef struct {
    AX_U16 nRoiOffsetH;       /* Accuracy: U14.0, Range: [0, 8192], default 0 */
    AX_U16 nRoiOffsetV;       /* Accuracy: U14.0, Range: [0, 8192], default 0 */
    AX_U8  nRoiRegionNumH;    /* Accuracy: U3.0, Range: [1, 5], default 1 */
    AX_U8  nRoiRegionNumV;    /* Accuracy: U3.0, Range: [1, 5], default 1 */
    AX_U16 nRoiRegionSizeH;       /* Accuracy: U14.0, Range: [256, 8192], default 256 */
    AX_U16 nRoiRegionSizeV;       /* Accuracy: U14.0, Range: [256, 8192], default 256 */
    AX_U8  nSearchRange;      /* Accuracy: U9.0, Range: [0, 256], default 128 */
} AX_ISP_IQ_EIS_STAT_ROI_T;

typedef struct {
    AX_U8  nEnable;               /* Accuracy: U1.0 Range: [0, 1] */
    AX_U8  nLutEnable;            /* Accuracy: U1.0 Range: [0, 1], default 0 */
    AX_U16 nLut[AX_EIS_LUT_NUM];  /* Accuracy: U8.2 Range: [0, 1023] */
    AX_U8  nProjShiftBit[AX_PROJ_SHIFT_BIT_DIRECTION_NUM];      /* Accuracy: U3.0 Range: [0, 4], [0]:H, [1]:V, default 0 */
    AX_U8  nScaleRatio;           /* Accuracy: U3.0 Range: [0, 2], default 0 */
    AX_ISP_IQ_EIS_STAT_ROI_T tGridRoiH;
    AX_ISP_IQ_EIS_STAT_ROI_T tGridRoiV;
} AX_ISP_IQ_EIS_STAT_PARAM_T;


/************************************************************************************
 *  EIS Stat Info
 ************************************************************************************/
#define AX_EIS_PROJ_NUM            (5)
#define AX_EIS_PROJ_DIV_NUM     (5)
#define AX_EIS_SAD_NUM              (256)

typedef struct {
    AX_U32 nSad[AX_EIS_PROJ_NUM * AX_EIS_PROJ_DIV_NUM][AX_EIS_SAD_NUM]; /* Accuracy: U24.0 Range: [0, 16777215] */
    AX_S8  nOffset[AX_EIS_PROJ_NUM][AX_EIS_PROJ_DIV_NUM]; /* Accuracy: S7.0 Range: [-128, 127] */
} AX_EIS_STAT_T;

typedef struct {
    AX_EIS_STAT_T tEisHStat;
    AX_EIS_STAT_T tEisVStat;
} AX_ISP_EIS_STAT_INFO_T;
...
typedef struct {
    AX_U8  nParamGrpNum;                                                          /* auto group number,Accuracy: U8.0 Range: [0x0, 0x8] */
    AX_U32 nRefVal[AX_ISP_AUTO_TABLE_MAX_NUM];
    AX_U16 nMotDetNoiseLut[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_MOTION_DET_LUT_SIZE]; /* noise and inverse profile for motion detection,default:[128...128][128...128],Accuracy: U8.4 Range: [0, 4095] */
    AX_S16 nMotDetStrenLuma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                             /* motion detection coring threshold and slope for Y channel,default:[0,0], Accuracy: S0.8 Range: [-255, 255] */
    AX_S16 nMotDetStrenChrom[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                            /* motion detection coring threshold and slope for uv channel,default:[0,0] Accuracy: S0.8 Range: [-255, 255] */
    AX_U8 nMotDetSmoothLuma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                             /* motion detection coring slope for Y channel,default:[16,16],Accuracy: U8 Range: [0, 16] */
    AX_U8 nMotDetSmoothChroma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                           /* motion detection coring threshold for UV channel,default:[16,16],Accuracy: U8 Range: [0, 16] */
    AX_U16 nMotDetLimitLuma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                             /* motion detection limit for Y channel,default:[0,256],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nMotDetLimitChrom[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                            /* motion detection limit for uv channel,default:[0,256],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nMotDetBlendRatio[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];  /* motion detection blend ratio(Y and UV channel result),default:[0,0] Accuracy: U1.8 Range: [0, 256] */
    AX_U8 nTfRatioLut[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_UPDATE_LUT_SIZE];        /* status refine lut,default:[128,86,64,51,43,37,32,28,26,23,21,20,18,17,16,15],Accuracy: U0.8 Range: [0, 255] */
    AX_U8 nTfRatLimitLuma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_BLEND_REGS_NUM];   /* Temporal Filter Limit for Y Channel,default:[0,255],Accuracy: U0.8 Range: [0, 255] */
    AX_U8 nTfRatLimitChroma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_BLEND_REGS_NUM]; /* Temporal Filter Limit for UV Channel,default:[0,255],Accuracy: U0.8 Range: [0, 255] */
    AX_U16 nSf0EdgeStre[AX_ISP_AUTO_TABLE_MAX_NUM];                                /* Edge Detection Coring Threshold and Coring Slope,default:128,Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf0DirStre[AX_ISP_AUTO_TABLE_MAX_NUM];                                 /* Edge Direction Detection Coring Threshold,default:128, Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf0DetailStre[AX_ISP_AUTO_TABLE_MAX_NUM];                              /* Detail Detection Coring Threshold and Coring Slope,default:128, Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf0LumaNoiseLut[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_MOTION_LUT_SIZE][YUV3DNR_AUTO_SF_LUT_SIZE]; /* SF0 NLM Threshold LUT,default:[0...0],Accuracy: U8.2 Range: [0, 1023] */
    AX_U8  nSf0LumaKernelSize[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];                          /* SF0 NLM Spatial Coefficients,default:(3,3),Accuracy: U2 Range: [0, 1, 2, 3] */
    AX_U16 nSf0LumaGauStre[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];     /* SF0 Gaussian FIlter Strength,default:128,Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf0lumaBlendRatio[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_AUTO_LUMA_BLEND_RATIO_SIZE]; /* SF0 YNR Blend Ratio,default:[256,0,0],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf0ChromaAttenStre[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM]; /* SF0 CNR Saturation Threshold adn Slope,default:[0,0],Accuracy: U8.2 Range: [0, 1023] */
    AX_U8  nSf0ChromaAttenLimit[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];/* SF0 CNR Saturation Limit,default:[0,0],Accuracy: U0.8 Range: [0, 255] */
    AX_U16 nSf0ChromaProtLut[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_AUTO_SF_LUT_SIZE]; /* SF0 CNR Protect Threshold and Slope LUT,default:[0...0],Accuracy: U8.2 Range: [0, 1023] */
    AX_U8  nSf1LumaMedEn[AX_ISP_AUTO_TABLE_MAX_NUM];                               /* median filter enable,defaule:1,Accuracy: U1 Range: [0, 1] */
    AX_U16 nSf1LumaGauStre[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];     /* SF1 YNR Gaussian Strength,defaule:[128,128],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf1LumaGauRatio[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];    /* SF1 YNR Gaussian Blend Ratio,defaule:[128,128],Accuracy: U1.8 Range: [0, 256] */
    AX_U8  nSf1LumaKernelSize[AX_ISP_AUTO_TABLE_MAX_NUM];                          /* SF1 YNR Bilateral Spatial Coefficients,defaule:2,Accuracy: U3 Range: [0, 1, 2] */
    AX_U16 nSf1LumaNoiseLut[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_AUTO_SF_LUT_SIZE];  /*SF1 YNR Bilateral Threshold and slope LUT,defaule:[1023,...1023],Accuracy: U8.2 Range: [0, 1023] */
    AX_U16 nSf1LumaIdrThre[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];     /* SF1 YNR Isolated Dot Removal Detection Threshold,default:[0,0],Accuracy: U8.2 Range: [0, 1023] */
    AX_U16 nSf1LumaIdrGain[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];     /* SF1 YNR Isolated Dot Removal Detection Gain,default:[128,128],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf1LumaClipLevel[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];   /* SF1 YNR Original Clip Level,default:[0,0],Accuracy: U8.2 Range: [0, 1023] */
    AX_U16 nSf1LumaCoring[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];      /* SF1 YNR Coring Threshold and coring slope,default:[0,0],Accuracy: U8.2 Range: [0, 1023] */
    AX_U16 nSf1LumaBlendRatio[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];  /* SF1 CNR Blend Ratio,default:0,Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf1ChromaCoring[AX_ISP_AUTO_TABLE_MAX_NUM];                            /* SF1 CNR Coring Threshold and coring slope,default:0,Accuracy: U8.2 Range: [0, 1023] */
    AX_U16 nSf1ChromaBlendRatio[AX_ISP_AUTO_TABLE_MAX_NUM];                        /* SF1 CNR Blend Ratio,default:0,Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nSf2LumaGauStre[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];     /* SF2 YNR Gaussian FIlter Strength,default:[128,128]Accuracy: U1.8 Range: [0, 256] */
    AX_U8  nSf2LumaMedEn[AX_ISP_AUTO_TABLE_MAX_NUM];                               /* SF2 YNR Median Filter Enable,default:1,Accuracy: U1 Range: [0, 1] */
    AX_U8  nSf2KernelSize[AX_ISP_AUTO_TABLE_MAX_NUM];                              /* SF2 YNR Bilateral Spatial Coefficients,default:1,Accuracy: U1 Range: [0, 1] */
    AX_U16 nSf2NoiseLut[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_AUTO_SF_LUT_SIZE];      /* SF2 YNR Bilateral Threshold LUT and slope Lut,default:[1023,1023,1023],Accuracy: U8.2 Range: [0, 1023] */
    AX_U16 nSf2BlendRatio[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM][YUV3DNR_AUTO_LUMA_BLEND_RATIO_SIZE];         /* SF2 YNR Blend Ratio,default:[256,0,0],Accuracy: U1.8 Range: [0, 256] */
    AX_U8 nExtMaskStrenLuma[AX_ISP_AUTO_TABLE_MAX_NUM];                            /* adjustment for Y channel motion mask or SF guide,default:128,Accuracy: U0.8 Range: [0, 255] */
    AX_U8 nExtMaskStrenChrom[AX_ISP_AUTO_TABLE_MAX_NUM];                           /* adjustment for UV channel motion mask or SF guide,default:128,Accuracy: U0.8 Range: [0, 255] */
    AX_U8 nExtMaskStrenStatus[AX_ISP_AUTO_TABLE_MAX_NUM];                          /* adjustment for motion STATUS update,128,Accuracy: U0.8 Range: [0, 255] */
    AX_U16 nExtMaskRatioLuma[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];   /* blend ratio for Y channel motion mask or SF guide,default:[0, 0],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nExtMaskRatioChrom[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM];  /* blend ratio for UV channel motion mask or SF guide,default:[0, 0],Accuracy: U1.8 Range: [0, 256] */
    AX_U16 nExtMaskRatioStatus[AX_ISP_AUTO_TABLE_MAX_NUM][YUV3DNR_BLEND_REGS_NUM]; /* blend ratio for motion STATUS update,default:[0, 0],Accuracy: U1.8 Range: [0, 256] */
...
typedef struct {
    ...
    AX_ISP_IQ_STATUS_REFINE_T tStatusRefineParam;
    AX_ISP_IQ_SF_GUIDE_MAP_T  tGuideMapParam;
...
AX_S32 AX_ISP_IQ_SetEisStatParam(AX_U8 nPipeId, AX_ISP_IQ_EIS_STAT_PARAM_T *pIspEisStatParam);
AX_S32 AX_ISP_IQ_GetEisStatParam(AX_U8 nPipeId, AX_ISP_IQ_EIS_STAT_PARAM_T *pIspEisStatParam);

AX_S32 AX_ISP_IQ_GetEisStatInfo(AX_U8 nPipeId, AX_ISP_EIS_STAT_INFO_T *pIspEisStatInfo);
