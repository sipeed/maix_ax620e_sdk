...
typedef enum {
    ...
    AX_ID_ISP_DEM       = 0x0C,
    AX_ID_ISP_GIC       = 0x0D,
    AX_ID_ISP_GAMMA     = 0x0E,
    AX_ID_ISP_DEHAZE    = 0x0F,
    AX_ID_ISP_CSC       = 0x10,
    AX_ID_ISP_OFL       = 0x11,
    AX_ID_ISP_REMAP     = 0x12,
    AX_ID_ISP_HDR       = 0x13,
    AX_ID_ISP_RAW3DNR   = 0x14,
    AX_ID_ISP_DEPURPLE  = 0x15,
    AX_ID_ISP_CC        = 0x16,
    AX_ID_ISP_CBLUT     = 0x17,
    AX_ID_ISP_LCE       = 0x18,
    AX_ID_ISP_PYRA      = 0x19,
    AX_ID_ISP_YUVSCALER = 0x1A,
    AX_ID_ISP_CA        = 0x1B,
    AX_ID_ISP_AINR      = 0x1C,
    AX_ID_ISP_AICE      = 0x1D,
    AX_ID_ISP_3DLUT     = 0x1E,
    AX_ID_ISP_SCENE     = 0x1F,
    AX_ID_ISP_FCC       = 0x20,
    AX_ID_ISP_RAW2DNR   = 0x21,
    AX_ID_ISP_YUV3DNR   = 0x22,
    AX_ID_ISP_LDC       = 0x23,
    AX_ID_ISP_CLP       = 0x24,
    AX_ID_ISP_ME_PRE    = 0x25,
    AX_ID_ISP_ME_POST   = 0x26,
    AX_ID_ISP_NUC       = 0x27,
    AX_ID_ISP_DIS       = 0x28,
    AX_ID_ISP_BUTT,
} AX_ISP_SUB_ID_E;
