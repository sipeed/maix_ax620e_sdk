...
#include "../../sensors/include/ax_sensor_struct.h"
...
#define AX_HDR_RATIO_CHN_NUM (3)
    ...
    {
        AX_S32 (*pfnAe_Init)
        (AX_U8 nPipeId, AX_ISP_AE_INITATTR_T *pAeInitParam, AX_ISP_AE_RESULT_T *pAeResult);
        AX_S32 (*pfnAe_Run)
        (AX_U8 nPipeId, AX_ISP_AE_INPUT_INFO_T *pAeInputInfo, AX_ISP_AE_RESULT_T *pAeResult);
        AX_S32 (*pfnAe_Exit)
        (AX_U8 nPipeId);
        AX_S32 (*pfnAe_Ctrl)
        (AX_U8 nPipeId, AX_ISP_CTRL_CMD_E eAeCtrlCmd, AX_ISP_AE_RESULT_T *pAeResult, void *pValue);
    ...
    {
        AX_S32 (*pfnAwb_Init)
        (AX_U8 nPipeId, AX_ISP_AWB_INITATTR_T *pAwbInitParam, AX_ISP_AWB_RESULT_T *pAwbResult);
        AX_S32 (*pfnAwb_Run)
        (AX_U8 nPipeId, AX_ISP_AWB_INPUT_INFO_T *pAwbInputInfo, AX_ISP_AWB_RESULT_T *pAwbResult);
        AX_S32 (*pfnAwb_Exit)
        (AX_U8 nPipeId);
        AX_S32 (*pfnAwb_Ctrl)
        (AX_U8 nPipeId, AX_ISP_CTRL_CMD_E eAwbCtrlCmd, AX_ISP_AWB_RESULT_T *pAwbResult, void *pValue);
