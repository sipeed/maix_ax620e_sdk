...
def do_spl(in_file, pub_file, prv_file, out_file, fw_file, part_size, capability):
    ...
    max_img_size = part_size - header_size
...
if __name__ == '__main__':
    ...
    '''
    ret = do_spl(in_file, pub_file, prv_file, out_file, fw_file, part_size, capability)
    if ret:
        print('sign complete')
