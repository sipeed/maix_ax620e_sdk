...
def do_spl(in_file, pub_file, prv_file, out_file, out_bk_file, fw_file, pack_size, capability, part_size):
    ...
    max_img_size = pack_size - header_size * 2
    all_img_pack_size = pack_size
    all_img_pack_size_bk = pack_size
...
if __name__ == '__main__':
    ...
    '''
    ret = do_spl(in_file, pub_file, prv_file, out_file, out_bk_file, fw_file, pack_size, capability, part_size)
    if ret:
