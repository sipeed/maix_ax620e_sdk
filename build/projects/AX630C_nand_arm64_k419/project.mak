...
FLASH_PARTITIONS  += $(ATF_PART),$(UBOOT_PART),$(ENV_PART),$(PARAM_PART),
...
root=$(ROOTFS_DEV) rw rootfstype=$(ROOTFS_TYPE) ubi.mtd=9,2048 root=ubi0:rootfs init=/linuxrc mtdparts=spi4.0:$(FLASH_PARTITIONS)"
