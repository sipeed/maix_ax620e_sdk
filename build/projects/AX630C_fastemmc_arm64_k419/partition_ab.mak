...
ifeq ($(strip $(AX_RISCV_SUPPORT)),TRUE)
FLASH_PARTITIONS  += $(RAWDATA_PART),$(RISCV_PART),$(RISCV_B_PART),
endif
...
RISCV_B_HEADER_FLASH_BASE     := $(call calculate_flash_base,$(FLASH_PARTITIONS),riscv_b)
endif
