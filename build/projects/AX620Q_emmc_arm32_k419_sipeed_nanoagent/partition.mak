...
FLASH_PARTITIONS  += $(UBOOT_PART),$(UBOOT_B_PART),
FLASH_PARTITIONS  += $(ENV_PART),$(LOGO_PART),
ifeq ($(strip $(SUPPORT_OPTEE)),TRUE)
FLASH_PARTITIONS  += $(OPTEE_PART),
endif
FLASH_PARTITIONS  += $(DTB_PART),$(KERNEL_PART),
FLASH_PARTITIONS  += $(BOOT_PART),-(rootfs)
