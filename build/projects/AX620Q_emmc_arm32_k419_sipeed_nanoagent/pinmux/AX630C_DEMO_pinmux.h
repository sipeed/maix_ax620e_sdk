...
0x02304084, 0x00040083,  /* PadName = UART3_TXD            Fuction = SEN_FLASH_D4 */
...
0x0230900C, 0x00000085,  /* PadName = EMMC_DAT5            Fuction = EMMC_DAT5 */
0x02309018, 0x00060083,  /* PadName = EMMC_RESET_N         Fuction = GPIO2_A23 */
0x02309024, 0x00000085,  /* PadName = EMMC_DAT4            Fuction = EMMC_DAT4 */
0x02309030, 0x00000085,  /* PadName = EMMC_DAT6            Fuction = EMMC_DAT6 */
0x0230903C, 0x00000045,  /* PadName = EMMC_DS              Fuction = EMMC_DS */
0x02309048, 0x00000085,  /* PadName = EMMC_DAT7            Fuction = EMMC_DAT7 */
0x02309054, 0x00000085,  /* PadName = EMMC_DAT3            Fuction = EMMC_DAT3 */
0x02309060, 0x00000085,  /* PadName = EMMC_DAT2            Fuction = EMMC_DAT2 */
0x0230906C, 0x00000005,  /* PadName = EMMC_CLK             Fuction = EMMC_CLK */
0x02309078, 0x00000085,  /* PadName = EMMC_DAT0            Fuction = EMMC_DAT0 */
0x02309084, 0x00000085,  /* PadName = EMMC_CMD             Fuction = EMMC_CMD */
0x02309090, 0x00000085,  /* PadName = EMMC_DAT1            Fuction = EMMC_DAT1 */
