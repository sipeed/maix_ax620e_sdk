...
0x02304030, 0x00060083,  /* PadName = I2C1_SDA             Fuction = GPIO0_A27 */
...
0x0230406C, 0x00000083,  /* PadName = UART2_TXD            Fuction = UART2_TXD */
0x02304078, 0x00000083,  /* PadName = UART2_RXD            Fuction = UART2_RXD */
0x02304084, 0x00010083,  /* PadName = UART3_TXD            Fuction = SPI_M2_MOSI */
0x02304090, 0x00060003,  /* PadName = UART3_RXD            Fuction = GPIO1_A3 */
0x104F0008, 0x0000000f,  /* SLEEP_CTRL */
0x104F0004, 0x00000201,  /* SLEEP_CTRL */
0x104F000C, 0x00060003,  /* PadName = EMAC_PTP_PPS0        Fuction = GPIO1_A8 */
0x104F0018, 0x00060003,  /* PadName = EMAC_PTP_PPS1        Fuction = GPIO1_A9 */
0x104F0024, 0x00060003,  /* PadName = EMAC_PTP_PPS2        Fuction = GPIO1_A10 */
0x104F0030, 0x00060003,  /* PadName = EMAC_PTP_PPS3        Fuction = GPIO1_A11 */
0x104F003C, 0x0000000F,  /* PadName = RGMII_MDCK           Fuction = RGMII_MDCK */
0x104F0048, 0x0000000F,  /* PadName = RGMII_MDIO           Fuction = RGMII_MDIO */
0x104F0054, 0x00060003,  /* PadName = EPHY_CLK             Fuction = EPHY_CLK */
0x104F0060, 0x00060008,  /* PadName = EPHY_RSTN            Fuction = GPIO1_A27 */
0x104F006C, 0x00000083,  /* PadName = EPHY_LED0            Fuction = EPHY_LED0 */
0x104F0078, 0x00060003,  /* PadName = EPHY_LED1            Fuction = GPIO1_A29 */
0x104F0084, 0x0000000F,  /* PadName = RGMII_RXD0           Fuction = RGMII_RXD0 */
0x104F0090, 0x0000000F,  /* PadName = RGMII_RXD1           Fuction = RGMII_RXD1 */
0x104F009C, 0x0000000F,  /* PadName = RGMII_RXDV           Fuction = RGMII_RXDV */
0x104F00A8, 0x0000000F,  /* PadName = RGMII_RXCLK          Fuction = RGMII_RXCLK */
0x104F00B4, 0x0000000F,  /* PadName = RGMII_RXD2           Fuction = RGMII_RXD2 */
0x104F00C0, 0x0000000F,  /* PadName = RGMII_RXD3           Fuction = RGMII_RXD3 */
0x104F00CC, 0x0000000F,  /* PadName = RGMII_TXD0           Fuction = RGMII_TXD0 */
0x104F00D8, 0x0000000F,  /* PadName = RGMII_TXD1           Fuction = RGMII_TXD1 */
0x104F00E4, 0x0000000F,  /* PadName = RGMII_TXCLK          Fuction = RGMII_TXCLK */
0x104F00F0, 0x0000000F,  /* PadName = RGMII_TXEN           Fuction = RGMII_TXEN */
0x104F00FC, 0x0000000F,  /* PadName = RGMII_TXD2           Fuction = RGMII_TXD2 */
0x104F0108, 0x0000000F,  /* PadName = RGMII_TXD3           Fuction = RGMII_TXD3 */
...
0x0230A00C, 0x00060003,  /* PadName = CDTX_L0N             Fuction = GPIO2_A10 */
0x0230A018, 0x00060003,  /* PadName = CDTX_L0P             Fuction = GPIO2_A11 */
0x0230A024, 0x00060003,  /* PadName = CDTX_L1N             Fuction = GPIO2_A12 */
0x0230A030, 0x00060003,  /* PadName = CDTX_L1P             Fuction = GPIO2_A13 */
0x0230A03C, 0x00060003,  /* PadName = CDTX_L2N             Fuction = GPIO2_A14 */
0x0230A048, 0x00060003,  /* PadName = CDTX_L2P             Fuction = GPIO2_A15 */
...
0x0230206C, 0x00060003,  /* PadName = BOND2                Fuction = GPIO0_A18 */
0x02302078, 0x00000043,  /* PadName = SYS_RSTN_OUT         Fuction = SYS_RSTN_OUT */
0x02302090, 0x00060003,  /* PadName = TMS                  Fuction = GPIO0_A21 */
0x0230209C, 0x00060003,  /* PadName = TCK                  Fuction = GPIO0_A22 */
