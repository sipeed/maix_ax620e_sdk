...
int utee_efuse_driver_write(uint32_t blk, uint32_t data);

int utee_efuse_driver_read(uint32_t blk, uint32_t *data);

int utee_efuse_driver_init(void);

int utee_efuse_driver_deinit(void);

int utee_efuse_driver_protect(uint32_t blk);
