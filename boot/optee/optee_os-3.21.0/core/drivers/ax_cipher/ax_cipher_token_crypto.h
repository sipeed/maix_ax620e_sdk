...
typedef enum {
	...
	VEXTOKEN_ALGO_MAC_ARIA_CMAC,
	VEXTOKEN_ALGO_MAC_ARIA_CBC_MAC,
	VEXTOKEN_ALGO_MAC_POLY1305 = 14,
} VexTokenAlgoMac_t;

static void Eip130Token_Command_WriteByteArray(Eip130Token_Command_t * const CommandToken, unsigned int StartWord, const uint8_t * Data, const unsigned int DataLenInBytes)
{
...
static void Eip130Token_Result_ReadByteArray(const Eip130Token_Result_t * const ResultToken_p, unsigned int StartWord, unsigned int DestLenOutBytes, uint8_t * Dest)
{
...
static inline void Eip130Token_Command_Crypto_Operation(Eip130Token_Command_t * const CommandToken,
							const uint8_t Algorithm, const uint8_t Mode, const bool fEncrypt, const uint32_t DataLengthInBytes)
{
...
static inline void Eip130Token_Command_Crypto_SetDataAddresses(Eip130Token_Command_t * const CommandToken,
							       const uint64_t InputDataAddress,
							       const uint32_t InputDataLengthInBytes, const uint64_t OutputDataAddress, const uint32_t OutputDataLengthInBytes)
{
	CommandToken->W[3] = (uint32_t) (InputDataAddress);
	CommandToken->W[4] = (uint32_t) (InputDataAddress >> 32);
	CommandToken->W[5] = InputDataLengthInBytes;
	CommandToken->W[6] = (uint32_t) (OutputDataAddress);
	CommandToken->W[7] = (uint32_t) (OutputDataAddress >> 32);
	CommandToken->W[8] = OutputDataLengthInBytes;
}

static inline void Eip130Token_Command_Crypto_CopyKey(Eip130Token_Command_t * const CommandToken, const uint8_t * const Key_p, const uint32_t KeyLengthInBytes)
{
	Eip130Token_Command_WriteByteArray(CommandToken, 17, Key_p, KeyLengthInBytes);
}

static inline void Eip130Token_Command_Crypto_SetKeyLength(Eip130Token_Command_t * const CommandToken, const uint32_t KeyLengthInBytes)
{
...
static inline void Eip130Token_Command_Crypto_CopyIV(Eip130Token_Command_t * const CommandToken, const uint8_t * const IV_p)
{
	Eip130Token_Command_WriteByteArray(CommandToken, 13, IV_p, 16);
}

static inline void
Eip130Token_Command_Hash(Eip130Token_Command_t * const CommandToken,
			 const uint8_t HashAlgo, const bool fInitWithDefault, const bool fFinalize, const uint64_t InputDataAddress, const uint32_t InputDataLengthInBytes)
{
...
static inline void Eip130Token_Command_Hash_SetTempDigestASID(Eip130Token_Command_t * const CommandToken, const uint32_t AssetId)
{
	CommandToken->W[7] = AssetId;
}

static inline void Eip130Token_Command_Hash_SetTotalMessageLength(Eip130Token_Command_t * const CommandToken, const uint64_t TotalMessageLengthInBytes)
{
	CommandToken->W[24] = (uint32_t) (TotalMessageLengthInBytes);
	CommandToken->W[25] = (uint32_t) (TotalMessageLengthInBytes >> 32);
}

static inline void Eip130Token_Command_Hash_CopyDigest(Eip130Token_Command_t * const CommandToken, const uint8_t * const Digest_p, const uint32_t DigestLenInBytes)
{
	Eip130Token_Command_WriteByteArray(CommandToken, 8, Digest_p, DigestLenInBytes);
}

static inline void Eip130Token_Result_Hash_CopyDigest(Eip130Token_Result_t * const ResultToken, const uint32_t DigestLenInBytes, uint8_t * Digest)
{
	Eip130Token_Result_ReadByteArray(ResultToken, 2, DigestLenInBytes, Digest);
}

static inline void
Eip130Token_Command_Mac(Eip130Token_Command_t * const CommandToken,
			const uint8_t MacAlgo, const bool fInit, const bool fFinalize, const uint64_t InputDataAddress, const uint32_t InputDataLengthInBytes)
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_MAC << 24);
	CommandToken->W[2] = InputDataLengthInBytes;
	CommandToken->W[3] = (uint32_t) (InputDataAddress);
	CommandToken->W[4] = (uint32_t) (InputDataAddress >> 32);
	CommandToken->W[5] = (uint32_t) ((InputDataLengthInBytes + 3) & (uint32_t) ~ 3);
...
static inline void Eip130Token_Command_Mac_SetTotalMessageLength(Eip130Token_Command_t * const CommandToken, const uint64_t TotalMessageLengthInBytes)
{
	CommandToken->W[24] = (uint32_t) (TotalMessageLengthInBytes);
	CommandToken->W[25] = (uint32_t) (TotalMessageLengthInBytes >> 32);
}

static inline void Eip130Token_Command_Mac_SetASLoadKey(Eip130Token_Command_t * const CommandToken, const uint32_t AssetId)
{
	CommandToken->W[6] |= BIT_8;
	CommandToken->W[28] = AssetId;
}

static inline void Eip130Token_Command_Mac_SetASLoadMAC(Eip130Token_Command_t * const CommandToken, const uint32_t AssetId)
{
	CommandToken->W[6] |= BIT_9;
	CommandToken->W[8] = AssetId;
}

static inline void Eip130Token_Command_Mac_CopyKey(Eip130Token_Command_t * const CommandToken, const uint8_t * const Key_p, const uint32_t KeyLengthInBytes)
{
...
static inline void Eip130Token_Command_Mac_CopyMAC(Eip130Token_Command_t * const CommandToken, const uint8_t * const MAC_p, const uint32_t MACLenInBytes)
{
	Eip130Token_Command_WriteByteArray(CommandToken, 8, MAC_p, MACLenInBytes);
}

static inline void Eip130Token_Result_Mac_CopyMAC(Eip130Token_Result_t * const ResultToken_p, const uint32_t MACLenInBytes, uint8_t * MAC_p)
{
	Eip130Token_Result_ReadByteArray(ResultToken_p, 2, MACLenInBytes, MAC_p);
}

static inline void Eip130Token_Command_RandomNumber_Generate(Eip130Token_Command_t * const CommandToken, const uint16_t NumberLengthInBytes, const uint64_t OutputDataAddress)
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_TRNG << 24) | (EIP130TOKEN_SUBCODE_RANDOMNUMBER << 28);
	CommandToken->W[2] = NumberLengthInBytes;
	CommandToken->W[3] = (uint32_t) (OutputDataAddress);
	CommandToken->W[4] = (uint32_t) (OutputDataAddress >> 32);
}

static inline void
Eip130Token_Command_TRNG_Configure(Eip130Token_Command_t * const CommandToken, const uint8_t AutoSeed, const uint16_t SampleCycles, const uint8_t SampleDiv, const uint8_t NoiseBlocks)
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_TRNG << 24) | (EIP130TOKEN_SUBCODE_TRNGCONFIG << 28);
	CommandToken->W[2] = (uint32_t) ((uint32_t) (AutoSeed << 8) | BIT_0);
	CommandToken->W[3] = (uint32_t) ((SampleCycles << 16) | ((SampleDiv & 0x0F) << 8) | NoiseBlocks);
}

static inline void Eip130Token_Command_AssetCreate(Eip130Token_Command_t * const CommandToken, const uint64_t Policy, const uint32_t LengthInBytes)
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_ASSETCREATE << 28);
	CommandToken->W[2] = (uint32_t) (Policy & 0xffffffff);
	CommandToken->W[3] = (uint32_t) (Policy >> 32);
	CommandToken->W[4] = (LengthInBytes & MASK_10_BITS) | BIT_28;
	CommandToken->W[5] = 0;
	CommandToken->W[6] = 0;
}

static inline void Eip130Token_Command_AssetDelete(Eip130Token_Command_t * const CommandToken, const uint32_t AssetId)
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_ASSETDELETE << 28);
	CommandToken->W[2] = AssetId;
}

static inline void Eip130Token_Command_AssetLoad_Plaintext(Eip130Token_Command_t * const CommandToken, const uint32_t AssetId)
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_ASSETLOAD << 28);
	CommandToken->W[2] = AssetId;
...
static inline void Eip130Token_Command_Pk_Asset_Command(Eip130Token_Command_t * const CommandToken, const uint8_t Command, const uint8_t Nwords, const uint8_t Mwords, const uint8_t OtherLen, const uint32_t KeyAssetId, const uint32_t ParamAssetId, const uint32_t IOAssetId, const uint64_t InputDataAddress, const uint16_t InputDataLengthInBytes, const uint64_t OutputDataAddress,	// or Signature address
							const uint16_t OutputDataLengthInBytes)	// or Signature length
{
	CommandToken->W[0] = (EIP130TOKEN_OPCODE_PUBLIC_KEY << 24) | (EIP130TOKEN_SUBCODE_PK_WITHASSETS << 28);
	CommandToken->W[2] = (uint32_t) (Command |	// PK operation to perform
				       (Nwords << 16) | (Mwords << 24));
	CommandToken->W[3] = (uint32_t) (OtherLen << 8);
	...
	CommandToken->W[7] = ((MASK_12_BITS & OutputDataLengthInBytes) << 16) | (MASK_12_BITS & InputDataLengthInBytes);
	CommandToken->W[8] = (uint32_t) (InputDataAddress);
	CommandToken->W[9] = (uint32_t) (InputDataAddress >> 32);
	CommandToken->W[10] = (uint32_t) (OutputDataAddress);
	CommandToken->W[11] = (uint32_t) (OutputDataAddress >> 32);
}

static inline void Eip130Token_Command_AssetLoad_SetInput(Eip130Token_Command_t * const CommandToken, const uint64_t DataAddress, const uint32_t DataLengthInBytes)
{
	CommandToken->W[3] |= (DataLengthInBytes & MASK_10_BITS);
	CommandToken->W[4] = (uint32_t) (DataAddress);
	CommandToken->W[5] = (uint32_t) (DataAddress >> 32);
}

static inline void Eip130Token_Command_Pk_Asset_SetAdditionalLength(Eip130Token_Command_t * const CommandToken, const uint64_t AddLength)
{
	uint32_t offset = ((CommandToken->W[3] & 0xFF) + 3) & (uint32_t) ~ 3;
	CommandToken->W[3] &= (uint32_t) ~ 0xFF;
	CommandToken->W[3] |= (offset + (2 * (uint32_t) sizeof(uint32_t)));
	CommandToken->W[12 + (offset / sizeof(uint32_t))] = (uint32_t) (AddLength);
	CommandToken->W[13 + (offset / sizeof(uint32_t))] = (uint32_t) (AddLength >> 32);
}

static inline void Eip130Token_Command_OTPDataWrite(Eip130Token_Command_t * const CommandToken_p,
						    const uint16_t AssetNumber,
						    const uint16_t PolicyNumber,
						    const bool fCRC,
						    const uint64_t InputDataAddress,
						    const uint16_t InputDataLengthInBytes, const uint8_t * const AssociatedData_p, const uint32_t AssociatedDataSizeInBytes)
{
	CommandToken_p->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_OTPDATAWRITE << 28);
	CommandToken_p->W[2] = (AssetNumber & MASK_5_BITS) | ((PolicyNumber & MASK_5_BITS) << 16);
	if (fCRC) {
		CommandToken_p->W[2] |= BIT_31;
	}
	CommandToken_p->W[3] = (InputDataLengthInBytes & MASK_10_BITS) | ((AssociatedDataSizeInBytes & MASK_10_BITS) << 16);
	CommandToken_p->W[4] = (uint32_t) (InputDataAddress);
	CommandToken_p->W[5] = (uint32_t) (InputDataAddress >> 32);

	Eip130Token_Command_WriteByteArray(CommandToken_p, 6, AssociatedData_p, AssociatedDataSizeInBytes);
}

static inline void
Eip130Token_Command_ProvisionRandomHUK(Eip130Token_Command_t * const CommandToken_p,
				       const uint16_t AssetNumber,
				       const bool f128bit,
				       const bool fCRC,
				       ...
				       const uint16_t OutputDataLengthInBytes, const uint8_t * const AssociatedData_p, const uint32_t AssociatedDataSizeInBytes)
{
	CommandToken_p->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_PROVISIONRANDOMHUK << 28);
	CommandToken_p->W[2] = (AssetNumber & MASK_5_BITS) | ((AutoSeed & MASK_8_BITS) << 8);
	if (f128bit) {
	...
	CommandToken_p->W[3] = (uint32_t) ((NoiseBlocks) + ((SampleDiv & MASK_4_BITS) << 8) + (uint32_t) (SampleCycles << 16));
	if (OutputDataLengthInBytes != 0) {
		CommandToken_p->W[2] |= BIT_31;
		CommandToken_p->W[4] = (OutputDataLengthInBytes & MASK_10_BITS) | ((AssociatedDataSizeInBytes & MASK_8_BITS) << 16);
		CommandToken_p->W[5] = (uint32_t) (OutputDataAddress);
		CommandToken_p->W[6] = (uint32_t) (OutputDataAddress >> 32);

		Eip130Token_Command_WriteByteArray(CommandToken_p, 7, AssociatedData_p, AssociatedDataSizeInBytes);
	}
}

static inline void Eip130Token_Command_PublicData_Read(Eip130Token_Command_t * const CommandToken_p, const uint32_t AssetID, const uint64_t DataAddress,
						       const uint32_t DataLengthInBytes)
{
	CommandToken_p->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_PUBLICDATA << 28);
...
static inline void Eip130Token_Command_AssetSearch(Eip130Token_Command_t * const CommandToken_p, const uint32_t AssetNumber)
{
	CommandToken_p->W[0] = (EIP130TOKEN_OPCODE_ASSETMANAGEMENT << 24) | (EIP130TOKEN_SUBCODE_ASSETSEARCH << 28);
	CommandToken_p->W[4] = (MASK_6_BITS & AssetNumber) << 16;
}

static inline void Eip130Token_Command_Identity(Eip130Token_Command_t * const CommandToken_p, uint32_t Identity)
{
	CommandToken_p->W[1] = Identity;
}

static inline void Eip130Token_Command_SystemReset(Eip130Token_Command_t * const CommandToken_p)
{
	CommandToken_p->W[0] = (EIP130TOKEN_OPCODE_SYSTEM << 24) | (EIP130TOKEN_SUBCODE_RESET << 28);
}

static inline void Eip130Token_Command_Crypto_SetASLoadKey(Eip130Token_Command_t * const CommandToken_p, const uint32_t AssetId)
{
