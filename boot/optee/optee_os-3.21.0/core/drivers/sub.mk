...
srcs-$(CFG_AX_EFUSE) += ax_efuse.c
srcs-$(CFG_AXERA_CIPHER) += ax_cipher/ax_aessiv.c
srcs-$(CFG_AXERA_CIPHER) += ax_cipher/ax_keyotpblob.c
srcs-$(CFG_AXERA_CIPHER) += ax_cipher/eip130_drv.c
srcs-$(CFG_AXERA_CIPHER) += ax_cipher/ax_cipher_api.c
srcs-$(CFG_AXERA_CIPHER) += ax_cipher/ax_cipher_optee.c
