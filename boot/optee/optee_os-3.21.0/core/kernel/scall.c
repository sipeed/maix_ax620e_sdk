...
static const struct syscall_entry tee_syscall_table[] = {
	...
	SYSCALL_ENTRY(syscall_efuse_driver_init),
	SYSCALL_ENTRY(syscall_efuse_driver_write),
	SYSCALL_ENTRY(syscall_efuse_driver_read),
	SYSCALL_ENTRY(syscall_efuse_driver_blk_protect),
	SYSCALL_ENTRY(syscall_efuse_driver_deinit),
};
