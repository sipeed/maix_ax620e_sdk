...
#define COMM_SYS_DUMMY_SW4	        (COMM_SYS_GLB + 0x200)
...
#define VPLL0_CFG0_ADDR       (PLLC_GLB_REG + 0x44)
#define VPLL0_CFG1_ADDR       (PLLC_GLB_REG + 0x50)
#define VPLL0_ON_CFG_SET_ADDR (PLLC_GLB_REG + 0x1D4)
#define VPLL0_ON_CFG_CLR_ADDR (PLLC_GLB_REG + 0x1D8)
#endif
