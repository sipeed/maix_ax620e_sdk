...
typedef struct _stVideoConfig {
    ...
    AX_VENC_RC_MODE_E eRcType{AX_VENC_RC_MODE_BUTT};
    AX_U32 nGop{APP_ENCODE_PARSE_INVALID};
    AX_F32 fSrcFrameRate{-1};
    AX_F32 fDstFrameRate{-1};
...
public:
    ...
    AX_BOOL UpdateRcInfo(RC_INFO_T& tRcInfo, AX_VENC_RC_MODE_E *eOldRcType=NULL);
    ...
    AX_BOOL UpdateFrameRate(AX_F32 fFrameRate);
    AX_BOOL RequestIDR(AX_BOOL bInstant=AX_TRUE);
...
private:
    ...
    AX_FRAME_RATE_CTRL_T m_tCfgFrameRate;
