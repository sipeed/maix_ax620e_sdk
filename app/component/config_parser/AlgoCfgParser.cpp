    ...
    do {
        ...
        if (objSkel.end() != objSkel.find("ae_roi_object_filter")) {
            ...
            for (size_t i = 0; i < nAeRoiSize; i++) {
                ...
                if (eHvcfpType < AX_APP_ALGO_HVCFP_TYPE_BUTT) {
                    if (eHvcfpType == AX_APP_ALGO_HVCFP_BODY
                        || eHvcfpType == AX_APP_ALGO_HVCFP_FACE) {
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_BODY].bEnable = (AX_BOOL)objAeRoi["enable"].get<bool>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_BODY].nWidth = objAeRoi["width"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_BODY].nHeight = objAeRoi["height"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_BODY].eMode = (AX_APP_ALGO_AE_ROI_MODE_E)objAeRoi["mode"].get<double>();

                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_FACE].bEnable = (AX_BOOL)objAeRoi["enable"].get<bool>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_FACE].nWidth = objAeRoi["width"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_FACE].nHeight = objAeRoi["height"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_FACE].eMode = (AX_APP_ALGO_AE_ROI_MODE_E)objAeRoi["mode"].get<double>();
                    } else {
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_VEHICLE].bEnable = (AX_BOOL)objAeRoi["enable"].get<bool>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_VEHICLE].nWidth = objAeRoi["width"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_VEHICLE].nHeight = objAeRoi["height"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_VEHICLE].eMode = (AX_APP_ALGO_AE_ROI_MODE_E)objAeRoi["mode"].get<double>();

                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_CYCLE].bEnable = (AX_BOOL)objAeRoi["enable"].get<bool>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_CYCLE].nWidth = objAeRoi["width"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_CYCLE].nHeight = objAeRoi["height"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_CYCLE].eMode = (AX_APP_ALGO_AE_ROI_MODE_E)objAeRoi["mode"].get<double>();

                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_PLATE].bEnable = (AX_BOOL)objAeRoi["enable"].get<bool>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_PLATE].nWidth = objAeRoi["width"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_PLATE].nHeight = objAeRoi["height"].get<double>();
                        stHvcfpParam.stAeRoiConfig[AX_APP_ALGO_HVCFP_PLATE].eMode = (AX_APP_ALGO_AE_ROI_MODE_E)objAeRoi["mode"].get<double>();
                    }
                }
            }
        }
