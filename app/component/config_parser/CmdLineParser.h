...
#define AX_APP_SCENARIO_TRIPLE "scenario_6"
#define AX_APP_SCENARIO_TRIPLE_SWITCH_SINGLE_PIPE "scenario_7"
...
typedef enum {
    ...
    E_LOAD_TYPE_OS12D40, /* E_SNS_TYPE_OS12D40 */
    E_LOAD_TYPE_IMX258, /* E_SNS_TYPE_IMX258 */

    // Sensor Combo
    E_LOAD_TYPE_COMBO_BASE = 100,
    E_LOAD_TYPE_OS04A10_SC200AI = 103, /* E_SNS_TYPE_OS04A10 + E_SNS_TYPE_SC200AI */
    E_LOAD_TYPE_SC450AI_SC200AI = 113, /* E_SNS_TYPE_SC450AI + E_SNS_TYPE_SC200AI */
    E_LOAD_TYPE_GC4653_SC200AI = 173, /* E_SNS_TYPE_GC4653 + E_SNS_TYPE_SC200AI */

    E_LOAD_TYPE_TRIPLE_COMBO_BASE = 1000,
    E_LOAD_TYPE_TRIPLE_OS04A10 = E_LOAD_TYPE_TRIPLE_COMBO_BASE, /* E_SNS_TYPE_OS04A10 + E_SNS_TYPE_OS04A10 + E_SNS_TYPE_OS04A10 */

    E_LOAD_TYPE_TRIPLE_SWITCH_SINGLE_PIPE_BASE = 2000,
    E_LOAD_TYPE_TRIPLE_SWITCH_SINGLE_PIPE_OS04A10_SC200AIx2 = 2033, /* E_SNS_TYPE_OS04A10 + E_SNS_TYPE_SC200AI x 2 switch */
    E_LOAD_TYPE_TRIPLE_SWITCH_SINGLE_PIPE_SC850SL_OS04A10x2 = 2500, /* E_SNS_TYPE_SC850SL + E_SNS_TYPE_OS04A10AI x 2 switch */
