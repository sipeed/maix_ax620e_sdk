...
AX_BOOL CAudioCfgParser::ParseACapJson(picojson::object &objJsonRoot, AX_APP_AUDIO_ATTR_T &stAudioAttr, AX_APP_AUDIO_CFG_T &stAudioCfg) {
    ...
    do {
        ...
        for (size_t i = 0; i < arrDevInst.size(); i++) {
            ...
            // capture.dev.instance[i].channels
            stCapDevAttr.nFSChannels = arrDevInst[i].get<picojson::object>()["channels"].get<double>();

            // capture.dev.instance[i].layout
            stCapDevAttr.eLayoutMode = (AX_APP_AUDIO_LAYOUT_MODE_E)arrDevInst[i].get<picojson::object>()["layout"].get<double>();
            ...
            stCapDevAttr.stVqeAttr.stAgcAttr.bEnable = (AX_BOOL)objDev3A["agc"].get<picojson::object>()["enable"].get<bool>();
            ...
            stCapDevAttr.stVqeAttr.stAgcAttr.nTargetLv = (AX_S16)objDev3A["agc"].get<picojson::object>()["target_level"].get<double>();

            // capture.dev.instance[i].3A.agc.gain
            stCapDevAttr.stVqeAttr.stAgcAttr.nGain = (AX_S16)objDev3A["agc"].get<picojson::object>()["gain"].get<double>();

            // capture.dev.instance[i].3A.ans.enable
            stCapDevAttr.stVqeAttr.stAnsAttr.bEnable = (AX_BOOL)objDev3A["ans"].get<picojson::object>()["enable"].get<bool>();
            ...
            if (AX_APP_AUDIO_AEC_FLOAT == stCapDevAttr.stVqeAttr.stAecAttr.eType) {
                ...
                stCapDevAttr.stVqeAttr.stAecAttr.stFloatAttr.eLevel = (AX_APP_AUDIO_AEC_SUPPRESSION_LEVEL_E)objDev3A["aec"]
                                                                          .get<picojson::object>()["float_attr"]
                                                                          .get<picojson::object>()["level"]
                                                                          .get<double>();
                ...
                stCapDevAttr.stVqeAttr.stAecAttr.stFixedAttr.eMode = (AX_APP_AUDIO_AEC_ROUTING_MODE_E)objDev3A["aec"]
                                                                         .get<picojson::object>()["fixed_attr"]
                                                                         .get<picojson::object>()["routing_mode"]
                                                                         .get<double>();
            }

            // capture.dev.instance[i].3A.vad.enable
            stCapDevAttr.stVqeAttr.stVadAttr.bEnable = (AX_BOOL)objDev3A["vad"].get<picojson::object>()["enable"].get<bool>();

            // capture.dev.instance[i].3A.vad.vad_level
            stCapDevAttr.stVqeAttr.stVadAttr.nVadLevel = (AX_U32)objDev3A["vad"].get<picojson::object>()["vad_level"].get<double>();
        }
        ...
        for (size_t i = 0; i < arrPipeInst.size(); i++) {
            ...
            if (PT_AAC == stAudioChanAttr.eType) {
                ...
                stAudioChanAttr.stAacEncoder.eAacType = (AX_APP_AUDIO_AAC_TYPE_E)arrPipeInst[i]
                                                            .get<picojson::object>()["aac_encoder"]
                                                            .get<picojson::object>()["aac_type"]
                                                            .get<double>();

                // capture.pipe.instance[i].aac_encoder.trans_type
                stAudioChanAttr.stAacEncoder.eTransType = (AX_APP_AUDIO_AAC_TRANS_TYPE_E)arrPipeInst[i]
                                                              .get<picojson::object>()["aac_encoder"]
                                                              .get<picojson::object>()["trans_type"]
                                                              .get<double>();
            } else {
...
AX_BOOL CAudioCfgParser::ParseAPlayJson(picojson::object &objJsonRoot, AX_APP_AUDIO_ATTR_T &stAudioAttr, AX_APP_AUDIO_CFG_T &stAudioCfg) {
    ...
    do {
        ...
        for (size_t i = 0; i < arrDevInst.size(); i++) {
            ...
            stPlayDevAttr.stVqeAttr.stAgcAttr.bEnable = (AX_BOOL)objDev3A["agc"].get<picojson::object>()["enable"].get<bool>();
            ...
            stPlayDevAttr.stVqeAttr.stAgcAttr.nTargetLv = (AX_S16)objDev3A["agc"].get<picojson::object>()["target_level"].get<double>();

            // play.dev.instance[i].3A.agc.gain
            stPlayDevAttr.stVqeAttr.stAgcAttr.nGain = (AX_S16)objDev3A["agc"].get<picojson::object>()["gain"].get<double>();

            // play.dev.instance[i].3A.ans.enable
            stPlayDevAttr.stVqeAttr.stAnsAttr.bEnable = (AX_BOOL)objDev3A["ans"].get<picojson::object>()["enable"].get<bool>();
        ...
        for (size_t i = 0; i < arrPipeInst.size(); i++) {
            ...
            if (PT_AAC == stAudioChanAttr.eType) {
                ...
                stAudioChanAttr.stAacDecoder.eTransType = (AX_APP_AUDIO_AAC_TRANS_TYPE_E)arrPipeInst[i]
                                                              .get<picojson::object>()["aac_decoder"]
                                                              .get<picojson::object>()["trans_type"]
                                                              .get<double>();
            } else {
