...
typedef struct axAPP_AUDIO_VAD_ATTR_T {
    AX_BOOL bEnable;
    AX_U32 nVadLevel;                 /*0 ~ 3 default 2*/
} AX_APP_AUDIO_VAD_ATTR_T, *AX_APP_AUDIO_VAD_ATTR_PTR;
...
typedef struct axAPP_AUDIO_CAP_VQE_ATTR_T {
    ...
    AX_APP_AUDIO_VAD_ATTR_T stVadAttr;
...
typedef struct axAPP_AUDIO_CAP_DEV_ATTR_T {
    ...
    AX_F32 fVolume;
    AX_U32 nFSChannels;
    AX_APP_AUDIO_LAYOUT_MODE_E eLayoutMode;
...
// audio acoustic event detection attribute
typedef struct axAPP_AUDIO_AED_ATTR_T {
    AX_BOOL bEnable;
    AX_F32 fThreshold;
    AX_U32 nInterval;
} AX_APP_AUDIO_AED_ATTR_T, *AX_APP_AUDIO_AED_ATTR_PTR;
...
//////////////////////////////////////////////////////////////////////////////////////
/// @brief audio get aed attribute
///
/// @param pstAttr      [O]: aed attribute
///
/// @return 0 if success, otherwise failure
//////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////
/// @brief register audio detect result observer
///
/// @param pObserver    [I]: observer
///
/// @return 0 if success, otherwise failure
...
//////////////////////////////////////////////////////////////////////////////////////
/// @brief unregister audio detect result observer
///
/// @param pObserver    [I]: observer
///
/// @return 0 if success, otherwise failure
