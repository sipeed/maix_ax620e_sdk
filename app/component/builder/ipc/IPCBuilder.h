...
private:
    ...
    AX_VOID SetWebFrameRateOption(const SENSOR_CONFIG_T& tSnsConfig, AX_BOOL bUpdateFrameRate = AX_FALSE);
protected:
    AX_VOID SendWebResetEvent(AX_U8 nSnsID);
...
private:
    ...
    AX_VIN_LOW_MEM_MODE_E m_eLowMemMode{AX_VIN_LOW_MEM_DISABLE};
};
