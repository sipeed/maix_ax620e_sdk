    ...
    switch (ops.eReqType) {
        ...
        case E_REQ_TYPE_CAMERA:
            if (E_WEB_OPERATION_TYPE_CAPTURE_ENABLE == ops.GetOperationType()) {
                ...
                m_pCurCameraAttr->tEZoomAttr.fEZoomRatio = ops.tEZoom.fEZoomRatio;
        ...
        case E_REQ_TYPE_AI:
            ...
            } else if (E_WEB_OPERATION_TYPE_AI_BODY_AE_ROI == ops.GetOperationType()) {
    ...
    switch (ops.eReqType) {
        ...
        case E_REQ_TYPE_CAMERA:
            ...
            if (E_WEB_OPERATION_TYPE_CAPTURE_ENABLE == ops.GetOperationType()) {
                ...
                if (m_pCurCameraAttr->tEZoomAttr.fEZoomRatio == ops.tEZoom.fEZoomRatio) {
                    ret = AX_TRUE;
                }
            } else if (E_WEB_OPERATION_TYPE_IMAGE_ATTR == ops.GetOperationType()) {
...
AX_VOID CTestSuite::PrintCaseParam(TESTSUITE_OPERATION_T& ops) {
    ...
    switch (ops.GetOperationType()) {
        ...
        case E_WEB_OPERATION_TYPE_EZOOM:
            LOG_MM_C(TESTSUITE, "%s: [SnsID:%d, sensor eZoomRatio:(%f ---> %f)]", ops.strDesc.c_str(), ops.nSnsID,
                     m_pCurCameraAttr->tEZoomAttr.fEZoomRatio, ops.tEZoom.fEZoomRatio);
            break;
