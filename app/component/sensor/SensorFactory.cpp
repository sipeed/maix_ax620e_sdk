...
ISensor *CSensorFactory::CreateSensor(const SENSOR_CONFIG_T &tSensorCfg) {
    ...
    switch (tSensorCfg.eSensorType) {
        ...
        case E_SNS_TYPE_OS12D40:
        case E_SNS_TYPE_OS12D40_LF:
        case E_SNS_TYPE_OS12D40_SF: {
#ifdef OS12D40_SUPPORT
            pSnsInstance = new COS12D40(tSensorCfg);
#else
            LOG_MM_E(SENSORFACTORY, "OS12D40 not support");
#endif
            break;
        }
        case E_SNS_TYPE_IMX258:
        case E_SNS_TYPE_IMX258_LF:
        case E_SNS_TYPE_IMX258_SF: {
#ifdef IMX258_SUPPORT
            pSnsInstance = new CIMX258(tSensorCfg);
#else
            LOG_MM_E(SENSORFACTORY, "IMX258 not support");
#endif
            break;
        }
        default: {
