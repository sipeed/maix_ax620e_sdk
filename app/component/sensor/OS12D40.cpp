...
#ifdef OS12D40_SUPPORT
#include "OS12D40.h"
#include "GlobalDef.h"

#define SENSOR_ATTR_WIDTH (4512)
#define SENSOR_ATTR_HEIGHT (2512)

COS12D40::COS12D40(SENSOR_CONFIG_T tSensorConfig) : CBaseSensor(tSensorConfig) {
...
COS12D40::~COS12D40(AX_VOID) {
}

AX_SNS_HDR_MODE_E COS12D40::GetMaxHdrMode() {
...
AX_VOID COS12D40::InitSnsLibraryInfo(AX_VOID) {
#ifndef USE_STATIC_LIBS
    if (m_tSnsCfg.m_tSnsLibInfo.strLibName.size() == 0) {
        m_tSnsCfg.m_tSnsLibInfo.strLibName = "libsns_os12d40.so";
    }

    if (m_tSnsCfg.m_tSnsLibInfo.strObjName.size() == 0) {
        m_tSnsCfg.m_tSnsLibInfo.strObjName = "gSnsos12d40Obj";
    }
#else
    extern AX_SENSOR_REGISTER_FUNC_T gSnsos12d40Obj;
    m_pSnsObj = &gSnsos12d40Obj;
#endif  // USE_STATIC_LIBS
}

AX_VOID COS12D40::InitSnsAttr() {
    ...
    // TODO:
    if (m_tSnsCfg.tSnsResolution.nSnsOutWidth == 4480) {
        m_tSnsCfg.arrSettingIndex[AX_SNS_LINEAR_MODE] = 2;
    } else if (m_tSnsCfg.tSnsResolution.nSnsOutWidth == 2240) {
        m_tSnsCfg.arrSettingIndex[AX_SNS_LINEAR_MODE] = 3;
    }
}

AX_VOID COS12D40::InitSnsClkAttr() {
    /* Referenced by AX_ISP_OpenSnsClk */
    m_tSnsClkAttr.nSnsClkIdx = m_tSnsCfg.nSnsID;
    m_tSnsClkAttr.eSnsClkRate = AX_SNS_CLK_24M;
}

AX_VOID COS12D40::InitMipiRxAttr() {
    ...
    m_tMipiRxDev.tMipiAttr.nDataRate = IS_SNS_HDR_MODE(m_tSnsCfg.eSensorMode) ? 1500 : 1500;
...
AX_VOID COS12D40::InitAbilities() {
    m_tAbilities.bSupportHDR = AX_TRUE;
    m_tAbilities.bSupportHDRSplit = AX_FALSE;
    m_tAbilities.fShutterSlowFpsThr = (-1 == m_tSnsCfg.fShutterSlowFpsThr) ? 15 : m_tSnsCfg.fShutterSlowFpsThr;
}
#endif
