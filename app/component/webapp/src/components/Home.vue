  ...
  <div class="home">
    <el-container class="home-container">
      <el-header>
        ...
        <div class="header_nav">
          <el-menu router :default-active="activePath" @select="handleSelect" mode="horizontal" background-color="#4c4c4c" text-color="#fff" active-text-color="#fff">
            ...
            <el-menu-item index="/setting" @click="saveNavState('/setting')" :disabled="!enable_setting" style="height: 50px;line-height: 50px;">配置</el-menu-item>
          </el-menu>
        </div>
      ...
      <el-main class="main-container">
        <router-view :mode_option="mode_option_data" :preview_sns_mode="sns_mode" :max_ezoom_ratio_0="max_ezoom_0" :max_ezoom_ratio_1="max_ezoom_1"></router-view>
      </el-main>
    </el-container>
  </div>
</template>
...
export default {
  data () {
    return {
      ...
      max_ezoom_0: parseInt(window.sessionStorage.getItem('maxEZoomRatio_0')),
      max_ezoom_1: parseInt(window.sessionStorage.getItem('maxEZoomRatio_1')),
      isForceStop: false
    }
  },
  created () {
