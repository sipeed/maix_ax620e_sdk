<template>
  <div>
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      ...
      <el-tab-pane label="防过曝策略" name="AEROI">
        <el-form ref="formAiRef" :rules="formAiRules" :model="formAi" label-width="100px" label-position="left" size="mini">
          <el-form-item label="人形防过曝:" v-show="formAi.ai_attr.ai_enable">
            <el-switch v-model="formAi.ai_attr.body_roi.enable"></el-switch>
          </el-form-item>
          <el-form-item label="车形防过曝:" v-show="formAi.ai_attr.ai_enable">
            <el-switch v-model="formAi.ai_attr.vehicle_roi.enable"></el-switch>
          </el-form-item>
        </el-form>
      </el-tab-pane>
    </el-tabs>
    ...
    async getInfo () {
      try {
        ...
        if (res.meta.status === 200) {
          ...
          this.formAi.ai_attr.vehicle_roi.enable = res.data.ai_attr.vehicle_roi.enable
          this.formAi.ai_attr.vehicle_roi.min_width = res.data.ai_attr.vehicle_roi.min_width
          this.formAi.ai_attr.vehicle_roi.min_height = res.data.ai_attr.vehicle_roi.min_height
          this.formAi.ai_attr.vehicle_roi.mode = res.data.ai_attr.vehicle_roi.mode
