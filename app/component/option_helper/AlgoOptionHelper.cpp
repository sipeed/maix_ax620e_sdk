...
AX_BOOL CAlgoOptionHelper::InitOnce() {
    ...
    for (size_t i = 0; i < AX_APP_ALGO_SNS_MAX; i++) {
        ...
        m_stAlgoParam[i].stHvcfpParam.stPushFliterConfig[AX_APP_ALGO_HVCFP_FACE].stFacePushFilterConfig.stFacePoseBlur.fPitch = 180;
        m_stAlgoParam[i].stHvcfpParam.stPushFliterConfig[AX_APP_ALGO_HVCFP_FACE].stFacePushFilterConfig.stFacePoseBlur.fYaw = 180;
        m_stAlgoParam[i].stHvcfpParam.stPushFliterConfig[AX_APP_ALGO_HVCFP_FACE].stFacePushFilterConfig.stFacePoseBlur.fRoll = 180;
        m_stAlgoParam[i].stHvcfpParam.stPushFliterConfig[AX_APP_ALGO_HVCFP_FACE].stFacePushFilterConfig.stFacePoseBlur.fBlur = 1.0;
