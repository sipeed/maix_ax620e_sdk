...
#ifndef __AX_MP4ENCODER_WRAPPER_H__
#define __AX_MP4ENCODER_WRAPPER_H__
...
typedef AX_VOID* AX_MP4ENCODER_HANDLE;

typedef struct _AX_MP4ENCODER_INFO_T {
    AX_BOOL bLoopSet;
    AX_U8 nSnsId;
    AX_U32 nChn;
    AX_U32 nMaxFileInMBytes;
    AX_U32 nMaxFileCount;
    AX_CHAR *pstrSavePath;
...
#endif  // __AX_MP4ENCODER_WRAPPER_H__
