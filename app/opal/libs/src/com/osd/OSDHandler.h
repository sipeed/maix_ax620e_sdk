...
#ifndef _OSD_HANDLER_H_
#define _OSD_HANDLER_H_
...
AX_VOID *GenARGB(wchar_t *pTextStr, AX_U16 *pArgbBuffer, AX_U32 u32OSDWidth, AX_U32 u32OSDHeight, AX_S16 sX, AX_S16 sY,
                 ...
                 AX_U32 uSideColor, OSD_ALIGN_TYPE_E enAlign);

AX_VOID *GenBitmap(wchar_t *pTextStr, AX_U8 *pBitmapBuffer, AX_U32 u32OSDWidth, AX_U32 u32OSDHeight, AX_S16 sX, AX_S16 sY,
